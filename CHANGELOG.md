...
IMPROVEMENTS:
* Support HTTP PROXY;
* Support FortiManager v7.4.11, 7.6.7, 8.0.0; 
* Support sort resources;

FEATURES:

* **New Resource:** `fmgdevice_antivirus_profile_websocket`
* **New Resource:** `fmgdevice_application_classificationsettings`
* **New Resource:** `fmgdevice_application_unsanctionedapps`
* **New Resource:** `fmgdevice_application_unsanctionedapps_move`
* **New Resource:** `fmgdevice_casb_useractivity_match_tenantsessionextraction`
* **New Resource:** `fmgdevice_casb_useractivity_match_tenantsessionextraction_filters`
* **New Resource:** `fmgdevice_dlp_settings_ocr`
* **New Resource:** `fmgdevice_firewall_customtag`
* **New Resource:** `fmgdevice_firewall_policy_fabricpolicy`
* **New Resource:** `fmgdevice_firewall_profileprotocoloptions_websocket`
* **New Resource:** `fmgdevice_log_customformat`
* **New Resource:** `fmgdevice_log_customformat_logtemplates`
* **New Resource:** `fmgdevice_router_multicast6flow`
* **New Resource:** `fmgdevice_router_multicast6flow_flows`
* **New Resource:** `fmgdevice_router_multicast6_pimsmglobalvrf`
* **New Resource:** `fmgdevice_router_multicast6_pimsmglobalvrf_rpaddress`
* **New Resource:** `fmgdevice_switchcontroller_igmpsnoopingstaticgroup`
* **New Resource:** `fmgdevice_switchcontroller_igmpsnoopingstaticgroup_ports`
* **New Resource:** `fmgdevice_switchcontroller_managedswitch_components_move`
* **New Resource:** `fmgdevice_switchcontroller_securitypolicy_admin`
* **New Resource:** `fmgdevice_system_csf_fabricdatasourceexemption`
* **New Resource:** `fmgdevice_system_csf_sharedobjects`
* **New Resource:** `fmgdevice_system_csf_sharedobjects_objects`
* **New Resource:** `fmgdevice_system_dhcp_template`
* **New Resource:** `fmgdevice_system_dhcp_template_excluderange`
* **New Resource:** `fmgdevice_system_dhcp_template_iprange`
* **New Resource:** `fmgdevice_system_dhcp_template_iprange_move`
* **New Resource:** `fmgdevice_system_dhcp_template_options`
* **New Resource:** `fmgdevice_system_dhcp_template_reservedaddress`
* **New Resource:** `fmgdevice_system_fortimq`
* **New Resource:** `fmgdevice_system_ha_linkgroup`
* **New Resource:** `fmgdevice_system_mqttbroker_topiclist`
* **New Resource:** `fmgdevice_system_theme`
* **New Resource:** `fmgdevice_vpn_ipsec_fec_mappings_tos`
* **New Resource:** `fmgdevice_vpn_ipsec_fec_mappings_tos_move`
* **New Resource:** `fmgdevice_ztna_connectoredge`
* **New Resource:** `fmgdevice_ztna_destinatio`
* **New Resource:** `fmgdevice_application_list_defaultnetworkservices_sort`
* **New Resource:** `fmgdevice_application_list_entries_sort`
* **New Resource:** `fmgdevice_application_unsanctionedapps_sort`
* **New Resource:** `fmgdevice_authentication_rule_sort`
* **New Resource:** `fmgdevice_casb_attributematch_sort`
* **New Resource:** `fmgdevice_casb_profile_sort`
* **New Resource:** `fmgdevice_casb_saasapplication_sort`
* **New Resource:** `fmgdevice_casb_useractivity_sort`
* **New Resource:** `fmgdevice_dlp_dictionary_entries_sort`
* **New Resource:** `fmgdevice_dlp_exactdatamatch_columns_sort`
* **New Resource:** `fmgdevice_dlp_filepattern_entries_sort`
* **New Resource:** `fmgdevice_dlp_label_entries_sort`
* **New Resource:** `fmgdevice_dlp_profile_rule_sort`
* **New Resource:** `fmgdevice_dlp_sensor_entries_sort`
* **New Resource:** `fmgdevice_dlp_sensor_filter_sort`
* **New Resource:** `fmgdevice_dnsfilter_domainfilter_entries_sort`
* **New Resource:** `fmgdevice_emailfilter_blockallowlist_entries_sort`
* **New Resource:** `fmgdevice_emailfilter_bword_entries_sort`
* **New Resource:** `fmgdevice_endpointcontrol_fctems_sort`
* **New Resource:** `fmgdevice_extensioncontroller_extenderprofile_cellular_smsnotification_receiver_sort`
* **New Resource:** `fmgdevice_extensioncontroller_extenderprofile_lanextension_backhaul_sort`
* **New Resource:** `fmgdevice_filefilter_profile_rules_sort`
* **New Resource:** `fmgdevice_firewall_DoSpolicy6_sort`
* **New Resource:** `fmgdevice_firewall_DoSpolicy_sort`
* **New Resource:** `fmgdevice_firewall_accessproxysshclientcert_sort`
* **New Resource:** `fmgdevice_firewall_accessproxyvirtualhost_sort`
* **New Resource:** `fmgdevice_firewall_accessproxy6_sort`
* **New Resource:** `fmgdevice_firewall_accessproxy_sort`
* **New Resource:** `fmgdevice_firewall_centralsnatmap_sort`
* **New Resource:** `fmgdevice_firewall_identitybasedroute_sort`
* **New Resource:** `fmgdevice_firewall_interfacepolicy6_sort`
* **New Resource:** `fmgdevice_firewall_interfacepolicy_sort`
* **New Resource:** `fmgdevice_firewall_localinpolicy6_sort`
* **New Resource:** `fmgdevice_firewall_localinpolicy_sort`
* **New Resource:** `fmgdevice_firewall_multicastpolicy6_sort`
* **New Resource:** `fmgdevice_firewall_multicastpolicy_sort`
* **New Resource:** `fmgdevice_firewall_policy_sort`
* **New Resource:** `fmgdevice_firewall_proxypolicy_sort`
* **New Resource:** `fmgdevice_firewall_responseshapingpolicy_sort`
* **New Resource:** `fmgdevice_firewall_securitypolicy_sort`
* **New Resource:** `fmgdevice_firewall_service_category_sort`
* **New Resource:** `fmgdevice_firewall_service_custom_sort`
* **New Resource:** `fmgdevice_firewall_shapingpolicy_sort`
* **New Resource:** `fmgdevice_firewall_shapingprofile_shapingentries_sort`
* **New Resource:** `fmgdevice_firewall_sniffer_sort`
* **New Resource:** `fmgdevice_firewall_ttlpolicy_sort`
* **New Resource:** `fmgdevice_firewall_vip6_sort`
* **New Resource:** `fmgdevice_firewall_vip_sort`
* **New Resource:** `fmgdevice_icap_localserver_icapservice_sort`
* **New Resource:** `fmgdevice_ips_sensor_entries_sort`
* **New Resource:** `fmgdevice_isolator_profile_entries_sort`
* **New Resource:** `fmgdevice_llm_server_sort`
* **New Resource:** `fmgdevice_nsxt_servicechain_serviceindex_sort`
* **New Resource:** `fmgdevice_report_layout_bodyitem_sort`
* **New Resource:** `fmgdevice_report_layout_page_footer_footeritem_sort`
* **New Resource:** `fmgdevice_report_layout_page_header_headeritem_sort`
* **New Resource:** `fmgdevice_router_policy6_sort`
* **New Resource:** `fmgdevice_router_policy_sort`
* **New Resource:** `fmgdevice_sshfilter_profile_shellcommands_sort`
* **New Resource:** `fmgdevice_switchcontroller_dynamicportpolicy_policy_sort`
* **New Resource:** `fmgdevice_switchcontroller_managedswitch_sort`
* **New Resource:** `fmgdevice_system_automationstitch_actions_sort`
* **New Resource:** `fmgdevice_system_dhcp_template_iprange_sort`
* **New Resource:** `fmgdevice_system_externalresource_sort`
* **New Resource:** `fmgdevice_system_healthcheckfortiguard_sort`
* **New Resource:** `fmgdevice_system_ipam_rules_sort`
* **New Resource:** `fmgdevice_system_sdnconnector_compartmentlist_sort`
* **New Resource:** `fmgdevice_system_sdnconnector_externalaccountlist_sort`
* **New Resource:** `fmgdevice_system_sdnconnector_forwardingrule_sort`
* **New Resource:** `fmgdevice_system_sdnconnector_ociregionlist_sort`
* **New Resource:** `fmgdevice_system_sdnconnector_routetable_sort`
* **New Resource:** `fmgdevice_system_sdwan_members_sort`
* **New Resource:** `fmgdevice_system_sdwan_service_sort`
* **New Resource:** `fmgdevice_system_sdwan_zone_sort`
* **New Resource:** `fmgdevice_user_nacpolicy_sort`
* **New Resource:** `fmgdevice_videofilter_profile_filters_sort`
* **New Resource:** `fmgdevice_videofilter_profile_fortiguardcategory_filters_sort`
* **New Resource:** `fmgdevice_vpn_ipsec_fec_mappings_sort`
* **New Resource:** `fmgdevice_vpn_ipsec_fec_mappings_tos_sort`
* **New Resource:** `fmgdevice_vpn_kmipserver_serverlist_sort`
* **New Resource:** `fmgdevice_vpn_ssl_settings_authenticationrule_sort`
* **New Resource:** `fmgdevice_vpn_ssl_web_portal_splitdns_sort`
* **New Resource:** `fmgdevice_vpn_ssl_web_userbookmark_bookmarks_sort`
* **New Resource:** `fmgdevice_vpn_ssl_web_usergroupbookmark_bookmarks_sort`
* **New Resource:** `fmgdevice_webproxy_redirectprofile_entries_sort`
* **New Resource:** `fmgdevice_webproxy_urllist_entries_sort`
* **New Resource:** `fmgdevice_webproxy_urlmatch_sort`
* **New Resource:** `fmgdevice_webfilter_urlfilter_entries_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_accesscontrollist_layer3ipv6rules_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_apcfgprofile_commandlist_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_bonjourprofile_policylist_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_vap_vlanname_sort`
* **New Resource:** `fmgdevice_wirelesscontroller_wtp_sort`
* **New Resource:** `fmgdevice_ztna_webportalbookmark_bookmarks_sort`
