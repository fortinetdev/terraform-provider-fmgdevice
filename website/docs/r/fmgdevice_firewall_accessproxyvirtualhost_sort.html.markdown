...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxyvirtualhost_sort"
description: |-
  Sort for firewall access-proxy-virtual-host.
---

# fmgdevice_firewall_accessproxyvirtualhost_sort
Sort for firewall access-proxy-virtual-host.

```hcl
resource "fmgdevice_firewall_accessproxyvirtualhost_sort" "test" {
	sortby        = "name"
