...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_routetable_sort"
description: |-
  Sort for system sdn-connector_route-table.
---

# fmgdevice_system_sdnconnector_routetable_sort
Sort for system sdn-connector_route-table.

```hcl
resource "fmgdevice_system_sdnconnector_routetable_sort" "test" {
	sortby        = "name"
