...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_identitybasedroute_sort"
description: |-
  Sort for firewall identity-based-route.
---

# fmgdevice_firewall_identitybasedroute_sort
Sort for firewall identity-based-route.

```hcl
resource "fmgdevice_firewall_identitybasedroute_sort" "test" {
	sortby        = "name"
