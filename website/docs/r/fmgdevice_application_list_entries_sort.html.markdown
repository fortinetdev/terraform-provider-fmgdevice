...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_application_list_entries_sort"
description: |-
  Sort for application list_entries.
---

# fmgdevice_application_list_entries_sort
Sort for application list_entries.

```hcl
resource "fmgdevice_application_list_entries_sort" "test" {
	sortby        = "id"
