...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ipsec_fec_mappings_tos_sort"
description: |-
  Sort for vpn ipsec_fec_mappings_tos.
---

# fmgdevice_vpn_ipsec_fec_mappings_tos_sort
Sort for vpn ipsec_fec_mappings_tos.

```hcl
resource "fmgdevice_vpn_ipsec_fec_mappings_tos_sort" "test" {
	sortby        = "seqno"
