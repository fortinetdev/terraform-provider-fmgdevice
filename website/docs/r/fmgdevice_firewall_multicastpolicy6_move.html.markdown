...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_multicastpolicy6_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv6 multicast NAT policies.
---

# fmgdevice_firewall_multicastpolicy6_move
<i>This object will be purged after policy copy and install.</i> Move IPv6 multicast NAT policies.
