...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_application_unsanctionedapps_sort"
description: |-
  Sort for application unsanctioned-apps.
---

# fmgdevice_application_unsanctionedapps_sort
Sort for application unsanctioned-apps.

```hcl
resource "fmgdevice_application_unsanctionedapps_sort" "test" {
	sortby        = "id"
