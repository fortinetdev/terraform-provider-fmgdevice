...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_service_custom_sort"
description: |-
  Sort for firewall service_custom.
---

# fmgdevice_firewall_service_custom_sort
Sort for firewall service_custom.

```hcl
resource "fmgdevice_firewall_service_custom_sort" "test" {
	sortby        = "name"
