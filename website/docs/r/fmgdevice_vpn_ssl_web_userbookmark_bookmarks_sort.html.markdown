...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ssl_web_userbookmark_bookmarks_sort"
description: |-
  Sort for vpn ssl_web_user-bookmark_bookmarks.
---

# fmgdevice_vpn_ssl_web_userbookmark_bookmarks_sort
Sort for vpn ssl_web_user-bookmark_bookmarks.

```hcl
resource "fmgdevice_vpn_ssl_web_userbookmark_bookmarks_sort" "test" {
	sortby        = "name"
