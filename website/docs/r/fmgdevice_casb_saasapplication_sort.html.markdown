...
subcategory: "CASB"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_casb_saasapplication_sort"
description: |-
  Sort for casb saas-application.
---

# fmgdevice_casb_saasapplication_sort
Sort for casb saas-application.

```hcl
resource "fmgdevice_casb_saasapplication_sort" "test" {
	sortby        = "name"
