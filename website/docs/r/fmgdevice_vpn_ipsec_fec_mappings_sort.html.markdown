...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ipsec_fec_mappings_sort"
description: |-
  Sort for vpn ipsec_fec_mappings.
---

# fmgdevice_vpn_ipsec_fec_mappings_sort
Sort for vpn ipsec_fec_mappings.

```hcl
resource "fmgdevice_vpn_ipsec_fec_mappings_sort" "test" {
	sortby        = "seqno"
