...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_shapingpolicy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move shaping policies.
---

# fmgdevice_firewall_shapingpolicy_move
<i>This object will be purged after policy copy and install.</i> Move shaping policies.
