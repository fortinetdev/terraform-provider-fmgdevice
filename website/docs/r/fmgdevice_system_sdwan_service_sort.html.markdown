...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdwan_service_sort"
description: |-
  Sort for system sdwan_service.
---

# fmgdevice_system_sdwan_service_sort
Sort for system sdwan_service.

```hcl
resource "fmgdevice_system_sdwan_service_sort" "test" {
	sortby        = "id"
