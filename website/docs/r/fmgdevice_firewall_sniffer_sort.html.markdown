...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_sniffer_sort"
description: |-
  Sort for firewall sniffer.
---

# fmgdevice_firewall_sniffer_sort
Sort for firewall sniffer.

```hcl
resource "fmgdevice_firewall_sniffer_sort" "test" {
	sortby        = "id"
