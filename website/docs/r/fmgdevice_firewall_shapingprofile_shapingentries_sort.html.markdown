...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_shapingprofile_shapingentries_sort"
description: |-
  Sort for firewall shaping-profile_shaping-entries.
---

# fmgdevice_firewall_shapingprofile_shapingentries_sort
Sort for firewall shaping-profile_shaping-entries.

```hcl
resource "fmgdevice_firewall_shapingprofile_shapingentries_sort" "test" {
	sortby        = "id"
