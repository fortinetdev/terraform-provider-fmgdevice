...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_emailfilter_bword_entries_sort"
description: |-
  Sort for emailfilter bword_entries.
---

# fmgdevice_emailfilter_bword_entries_sort
Sort for emailfilter bword_entries.

```hcl
resource "fmgdevice_emailfilter_bword_entries_sort" "test" {
	sortby        = "id"
