...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_emailfilter_blockallowlist_entries_sort"
description: |-
  Sort for emailfilter block-allow-list_entries.
---

# fmgdevice_emailfilter_blockallowlist_entries_sort
Sort for emailfilter block-allow-list_entries.

```hcl
resource "fmgdevice_emailfilter_blockallowlist_entries_sort" "test" {
	sortby        = "id"
