...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_proxypolicy_sort"
description: |-
  Sort for firewall proxy-policy.
---

# fmgdevice_firewall_proxypolicy_sort
Sort for firewall proxy-policy.

```hcl
resource "fmgdevice_firewall_proxypolicy_sort" "test" {
	sortby        = "policyid"
