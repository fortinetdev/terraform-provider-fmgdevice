...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_videofilter_profile_filters_sort"
description: |-
  Sort for videofilter profile_filters.
---

# fmgdevice_videofilter_profile_filters_sort
Sort for videofilter profile_filters.

```hcl
resource "fmgdevice_videofilter_profile_filters_sort" "test" {
	sortby        = "id"
