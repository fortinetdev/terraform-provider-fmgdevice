...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_webproxy_urlmatch_sort"
description: |-
  Sort for web-proxy url-match.
---

# fmgdevice_webproxy_urlmatch_sort
Sort for web-proxy url-match.

```hcl
resource "fmgdevice_webproxy_urlmatch_sort" "test" {
	sortby        = "name"
