...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_ociregionlist_sort"
description: |-
  Sort for system sdn-connector_oci-region-list.
---

# fmgdevice_system_sdnconnector_ociregionlist_sort
Sort for system sdn-connector_oci-region-list.

```hcl
resource "fmgdevice_system_sdnconnector_ociregionlist_sort" "test" {
	sortby        = "region"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "region".
...
* `sortby` - Sort security policies by the value, it currently supports "region".
