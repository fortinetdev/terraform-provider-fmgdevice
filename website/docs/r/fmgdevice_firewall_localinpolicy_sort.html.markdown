...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_localinpolicy_sort"
description: |-
  Sort for firewall local-in-policy.
---

# fmgdevice_firewall_localinpolicy_sort
Sort for firewall local-in-policy.

```hcl
resource "fmgdevice_firewall_localinpolicy_sort" "test" {
	sortby        = "policyid"
