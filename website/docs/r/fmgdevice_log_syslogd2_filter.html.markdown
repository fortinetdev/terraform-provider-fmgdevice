...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_syslogd2_filter"
description: |-
  Filters for remote system server.
---

# fmgdevice_log_syslogd2_filter
Filters for remote system server.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `free_style`: `fmgdevice_log_syslogd2_filter_freestyle`
...
```hcl
resource "fmgdevice_log_syslogd2_filter" "trname" {
  anomaly         = "disable"
...
Log Syslogd2Filter can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_syslogd2_filter.labelname LogSyslogd2Filter
