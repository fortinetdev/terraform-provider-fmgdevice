...
subcategory: "IPS"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_ips_sensor_entries_sort"
description: |-
  Sort for ips sensor_entries.
---

# fmgdevice_ips_sensor_entries_sort
Sort for ips sensor_entries.

```hcl
resource "fmgdevice_ips_sensor_entries_sort" "test" {
	sortby        = "id"
