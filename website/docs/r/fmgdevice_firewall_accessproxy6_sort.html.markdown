...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy6_sort"
description: |-
  Sort for firewall access-proxy6.
---

# fmgdevice_firewall_accessproxy6_sort
Sort for firewall access-proxy6.

```hcl
resource "fmgdevice_firewall_accessproxy6_sort" "test" {
	sortby        = "name"
