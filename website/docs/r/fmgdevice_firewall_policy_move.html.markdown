...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_policy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv4/IPv6 policies.
---

# fmgdevice_firewall_policy_move
<i>This object will be purged after policy copy and install.</i> Move IPv4/IPv6 policies.
