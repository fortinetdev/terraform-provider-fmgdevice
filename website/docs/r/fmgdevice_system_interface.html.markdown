...
* `profiles` - Set allowed VDSL profiles. Valid values: `8a`, `8b`, `8c`, `8d`, `12a`, `12b`, `17a`, `30a`, `35b`.
...
* `telemetry_discover` - Enable/disable automatic registration of unknown FortiTelemetry agents. Valid values: `disable`, `enable`.
