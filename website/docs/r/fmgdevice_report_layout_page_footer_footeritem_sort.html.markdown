...
subcategory: "Report"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_report_layout_page_footer_footeritem_sort"
description: |-
  Sort for report layout_page_footer_footer-item.
---

# fmgdevice_report_layout_page_footer_footeritem_sort
Sort for report layout_page_footer_footer-item.

```hcl
resource "fmgdevice_report_layout_page_footer_footeritem_sort" "test" {
	sortby        = "id"
