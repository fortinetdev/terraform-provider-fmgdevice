...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_externalresource_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move external resource.
---

# fmgdevice_system_externalresource_move
<i>This object will be purged after policy copy and install.</i> Move external resource.
