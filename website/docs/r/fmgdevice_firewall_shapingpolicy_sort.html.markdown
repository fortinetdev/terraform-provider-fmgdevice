...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_shapingpolicy_sort"
description: |-
  Sort for firewall shaping-policy.
---

# fmgdevice_firewall_shapingpolicy_sort
Sort for firewall shaping-policy.

```hcl
resource "fmgdevice_firewall_shapingpolicy_sort" "test" {
	sortby        = "id"
