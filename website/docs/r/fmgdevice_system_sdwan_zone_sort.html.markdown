...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdwan_zone_sort"
description: |-
  Sort for system sdwan_zone.
---

# fmgdevice_system_sdwan_zone_sort
Sort for system sdwan_zone.

```hcl
resource "fmgdevice_system_sdwan_zone_sort" "test" {
	sortby        = "name"
