...
subcategory: "DLP"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_profile_rule_sort"
description: |-
  Sort for dlp profile_rule.
---

# fmgdevice_dlp_profile_rule_sort
Sort for dlp profile_rule.

```hcl
resource "fmgdevice_dlp_profile_rule_sort" "test" {
	sortby        = "id"
