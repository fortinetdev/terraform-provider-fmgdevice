...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_ips_sensor_entries_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> IPS sensor filter.
---

# fmgdevice_ips_sensor_entries_move
<i>This object will be purged after policy copy and install.</i> IPS sensor filter.
