...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_dospolicy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv4 DoS policies.
---

# fmgdevice_firewall_dospolicy_move
<i>This object will be purged after policy copy and install.</i> Move IPv4 DoS policies.
