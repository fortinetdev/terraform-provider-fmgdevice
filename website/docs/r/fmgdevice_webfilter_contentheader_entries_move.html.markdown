...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_webfilter_contentheader_entries_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move content types used by web filter.
---

# fmgdevice_webfilter_contentheader_entries_move
<i>This object will be purged after policy copy and install.</i> Move content types used by web filter.
