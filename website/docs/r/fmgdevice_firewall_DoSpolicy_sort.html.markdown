...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_DoSpolicy_sort"
description: |-
  Sort for firewall DoS-policy.
---

# fmgdevice_firewall_DoSpolicy_sort
Sort for firewall DoS-policy.

```hcl
resource "fmgdevice_firewall_DoSpolicy_sort" "test" {
	sortby        = "policyid"
