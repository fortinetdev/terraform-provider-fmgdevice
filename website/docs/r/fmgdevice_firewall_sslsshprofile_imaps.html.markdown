...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_sslsshprofile_imaps"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure IMAPS options.
---

# fmgdevice_firewall_sslsshprofile_imaps
<i>This object will be purged after policy copy and install.</i> Configure IMAPS options.

~> This resource is a sub resource for variable `imaps` of resource `fmgdevice_firewall_sslsshprofile`. Conflict and overwrite may occur if use both of them.
...
Firewall SslSshProfileImaps can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_sslsshprofile_imaps.labelname FirewallSslSshProfileImaps
