...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort"
description: |-
  Sort for wireless-controller mpsk-profile_mpsk-group_mpsk-key.
---

# fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort
Sort for wireless-controller mpsk-profile_mpsk-group_mpsk-key.

```hcl
resource "fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort" "test" {
	sortby        = "name"
