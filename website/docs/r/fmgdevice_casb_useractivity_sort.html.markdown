...
subcategory: "CASB"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_casb_useractivity_sort"
description: |-
  Sort for casb user-activity.
---

# fmgdevice_casb_useractivity_sort
Sort for casb user-activity.

```hcl
resource "fmgdevice_casb_useractivity_sort" "test" {
	sortby        = "name"
