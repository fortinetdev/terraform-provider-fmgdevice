...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_filefilter_profile_rules_sort"
description: |-
  Sort for file-filter profile_rules.
---

# fmgdevice_filefilter_profile_rules_sort
Sort for file-filter profile_rules.

```hcl
resource "fmgdevice_filefilter_profile_rules_sort" "test" {
	sortby        = "name"
