...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_centralsnatmap_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv4 and IPv6 central SNAT policies.
---

# fmgdevice_firewall_centralsnatmap_move
<i>This object will be purged after policy copy and install.</i> Move IPv4 and IPv6 central SNAT policies.
