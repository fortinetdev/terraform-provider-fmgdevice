...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_dhcp_template"
description: |-
  Configure DHCP server templates.
---

# fmgdevice_system_dhcp_template
Configure DHCP server templates.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `exclude_range`: `fmgdevice_system_dhcp_template_excluderange`
>- `ip_range`: `fmgdevice_system_dhcp_template_iprange`
>- `options`: `fmgdevice_system_dhcp_template_options`
>- `reserved_address`: `fmgdevice_system_dhcp_template_reservedaddress`
...
* `mac_acl_default_action` - MAC access control default action (allow or block assigning IP settings). Valid values: `block`, `assign`.
...
System DhcpTemplate can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_system_dhcp_template.labelname {{name}}
