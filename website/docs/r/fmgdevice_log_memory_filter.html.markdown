...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_memory_filter"
description: |-
  Filters for memory buffer.
---

# fmgdevice_log_memory_filter
Filters for memory buffer.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `free_style`: `fmgdevice_log_memory_filter_freestyle`
...
```hcl
resource "fmgdevice_log_memory_filter" "trname" {
  anomaly         = "enable"
...
Log MemoryFilter can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_memory_filter.labelname LogMemoryFilter
