...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_profileprotocoloptions_imap"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure IMAP protocol options.
---

# fmgdevice_firewall_profileprotocoloptions_imap
<i>This object will be purged after policy copy and install.</i> Configure IMAP protocol options.

~> This resource is a sub resource for variable `imap` of resource `fmgdevice_firewall_profileprotocoloptions`. Conflict and overwrite may occur if use both of them.
...
Firewall ProfileProtocolOptionsImap can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_profileprotocoloptions_imap.labelname FirewallProfileProtocolOptionsImap
