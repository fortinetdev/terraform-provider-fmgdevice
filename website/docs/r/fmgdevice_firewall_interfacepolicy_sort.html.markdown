...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_interfacepolicy_sort"
description: |-
  Sort for firewall interface-policy.
---

# fmgdevice_firewall_interfacepolicy_sort
Sort for firewall interface-policy.

```hcl
resource "fmgdevice_firewall_interfacepolicy_sort" "test" {
	sortby        = "policyid"
