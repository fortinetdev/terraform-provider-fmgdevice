...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy6_apigateway_sslciphersuites"
description: |-
...
# fmgdevice_firewall_accessproxy6_apigateway_sslciphersuites
<i>This object will be purged after policy copy and install.</i> SSL/TLS cipher suites to offer to a server, ordered by priority.

~> This resource is a sub resource for variable `ssl_cipher_suites` of resource `fmgdevice_firewall_accessproxy6_apigateway`. Conflict and overwrite may occur if use both of them.
...
Firewall AccessProxy6ApiGatewaySslCipherSuites can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_accessproxy6_apigateway_sslciphersuites.labelname {{priority}}
