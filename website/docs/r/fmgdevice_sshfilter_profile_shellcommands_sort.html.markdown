...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_sshfilter_profile_shellcommands_sort"
description: |-
  Sort for ssh-filter profile_shell-commands.
---

# fmgdevice_sshfilter_profile_shellcommands_sort
Sort for ssh-filter profile_shell-commands.

```hcl
resource "fmgdevice_sshfilter_profile_shellcommands_sort" "test" {
	sortby        = "id"
