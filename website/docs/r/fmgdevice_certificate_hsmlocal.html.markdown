...
# fmgdevice_certificate_hsmlocal
Local certificates whose keys are stored on HSM.
...
Certificate HsmLocal can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_certificate_hsmlocal.labelname {{name}}
