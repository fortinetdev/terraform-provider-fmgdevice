...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_filepattern_entries_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move file patterns used by DLP blocking.
---

# fmgdevice_dlp_filepattern_entries_move
<i>This object will be purged after policy copy and install.</i> Move file patterns used by DLP blocking.
