...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_multicastpolicy6_sort"
description: |-
  Sort for firewall multicast-policy6.
---

# fmgdevice_firewall_multicastpolicy6_sort
Sort for firewall multicast-policy6.

```hcl
resource "fmgdevice_firewall_multicastpolicy6_sort" "test" {
	sortby        = "id"
