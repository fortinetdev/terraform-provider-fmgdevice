...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_externalresource_sort"
description: |-
  Sort for system external-resource.
---

# fmgdevice_system_externalresource_sort
Sort for system external-resource.

```hcl
resource "fmgdevice_system_externalresource_sort" "test" {
	sortby        = "name"
