...
subcategory: "ZTNA"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_ztna_webportalbookmark_bookmarks_sort"
description: |-
  Sort for ztna web-portal-bookmark_bookmarks.
---

# fmgdevice_ztna_webportalbookmark_bookmarks_sort
Sort for ztna web-portal-bookmark_bookmarks.

```hcl
resource "fmgdevice_ztna_webportalbookmark_bookmarks_sort" "test" {
	sortby        = "name"
