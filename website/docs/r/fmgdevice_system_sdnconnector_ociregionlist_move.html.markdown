...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_ociregionlist_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move OCI region list.
---

# fmgdevice_system_sdnconnector_ociregionlist_move
<i>This object will be purged after policy copy and install.</i> Move OCI region list.
