...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_securitypolicy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move NGFW IPv4/IPv6 application policies.
---

# fmgdevice_firewall_securitypolicy_move
<i>This object will be purged after policy copy and install.</i> Move NGFW IPv4/IPv6 application policies.
