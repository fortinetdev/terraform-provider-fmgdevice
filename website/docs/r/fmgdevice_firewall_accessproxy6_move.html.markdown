...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy6_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv6 access proxy.
---

# fmgdevice_firewall_accessproxy6_move
<i>This object will be purged after policy copy and install.</i> Move IPv6 access proxy.
