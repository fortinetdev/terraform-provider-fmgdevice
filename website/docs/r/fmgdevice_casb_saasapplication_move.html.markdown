...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_casb_saasapplication_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move CASB SaaS application.
---

# fmgdevice_casb_saasapplication_move
<i>This object will be purged after policy copy and install.</i> Move CASB SaaS application.
