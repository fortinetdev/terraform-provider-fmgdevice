...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ssl_web_usergroupbookmark_bookmarks_sort"
description: |-
  Sort for vpn ssl_web_user-group-bookmark_bookmarks.
---

# fmgdevice_vpn_ssl_web_usergroupbookmark_bookmarks_sort
Sort for vpn ssl_web_user-group-bookmark_bookmarks.

```hcl
resource "fmgdevice_vpn_ssl_web_usergroupbookmark_bookmarks_sort" "test" {
	sortby        = "name"
