...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_responseshapingpolicy_sort"
description: |-
  Sort for firewall response-shaping-policy.
---

# fmgdevice_firewall_responseshapingpolicy_sort
Sort for firewall response-shaping-policy.

```hcl
resource "fmgdevice_firewall_responseshapingpolicy_sort" "test" {
	sortby        = "id"
