...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_router_aspathlist"
description: |-
  Configure Autonomous System (AS) path lists.
---

# fmgdevice_router_aspathlist
Configure Autonomous System (AS) path lists.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `rule`: `fmgdevice_router_aspathlist_rule`
...
$ terraform import fmgdevice_router_aspathlist.labelname {{name}}
