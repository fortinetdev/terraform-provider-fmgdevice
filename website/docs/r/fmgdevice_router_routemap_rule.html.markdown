...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_router_routemap_rule"
description: |-
  Rule.
---

# fmgdevice_router_routemap_rule
Rule.

~> This resource is a sub resource for variable `rule` of resource `fmgdevice_router_routemap`. Conflict and overwrite may occur if use both of them.
...
* `set_metric_type` - Metric type. Valid values: `none`, `external-type1`, `external-type2`.
...
Router RouteMapRule can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE", "route_map=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_router_routemap_rule.labelname {{fosid}}
