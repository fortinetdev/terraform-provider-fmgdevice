...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_videofilter_profile_fortiguardcategory_filters_sort"
description: |-
  Sort for videofilter profile_fortiguard-category_filters.
---

# fmgdevice_videofilter_profile_fortiguardcategory_filters_sort
Sort for videofilter profile_fortiguard-category_filters.

```hcl
resource "fmgdevice_videofilter_profile_fortiguardcategory_filters_sort" "test" {
	sortby        = "id"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "id".
...
* `sortby` - Sort security policies by the value, it currently supports "id".
