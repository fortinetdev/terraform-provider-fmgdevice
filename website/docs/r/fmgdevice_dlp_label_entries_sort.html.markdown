...
subcategory: "DLP"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_label_entries_sort"
description: |-
  Sort for dlp label_entries.
---

# fmgdevice_dlp_label_entries_sort
Sort for dlp label_entries.

```hcl
resource "fmgdevice_dlp_label_entries_sort" "test" {
	sortby        = "id"
