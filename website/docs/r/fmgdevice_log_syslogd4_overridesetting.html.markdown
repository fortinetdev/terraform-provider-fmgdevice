...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_syslogd4_overridesetting"
description: |-
...
>- `custom_field_name`: `fmgdevice_log_syslogd4_overridesetting_customfieldname`
>- `log_templates`: `fmgdevice_log_syslogd4_overridesetting_logtemplates`
...
```hcl
resource "fmgdevice_log_syslogd4_overridesetting" "trname" {
...
Log Syslogd4OverrideSetting can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_syslogd4_overridesetting.labelname LogSyslogd4OverrideSetting
