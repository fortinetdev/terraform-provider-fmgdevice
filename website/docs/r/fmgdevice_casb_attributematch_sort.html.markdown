...
subcategory: "CASB"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_casb_attributematch_sort"
description: |-
  Sort for casb attribute-match.
---

# fmgdevice_casb_attributematch_sort
Sort for casb attribute-match.

```hcl
resource "fmgdevice_casb_attributematch_sort" "test" {
	sortby        = "name"
