...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_localinpolicy6"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure user defined IPv6 local-in policies.
---

# fmgdevice_firewall_localinpolicy6
<i>This object will be purged after policy copy and install.</i> Configure user defined IPv6 local-in policies.
...
$ terraform import fmgdevice_firewall_localinpolicy6.labelname {{policyid}}
