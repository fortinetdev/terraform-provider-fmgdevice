...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_dhcp_template_excluderange"
description: |-
  Exclude one or more ranges of IP addresses from being assigned to clients.
---

# fmgdevice_system_dhcp_template_excluderange
Exclude one or more ranges of IP addresses from being assigned to clients.

~> This resource is a sub resource for variable `exclude_range` of resource `fmgdevice_system_dhcp_template`. Conflict and overwrite may occur if use both of them.
...
System DhcpTemplateExcludeRange can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "template=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_system_dhcp_template_excluderange.labelname {{fosid}}
