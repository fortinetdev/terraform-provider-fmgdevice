...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_webproxy_urllist_entries_sort"
description: |-
  Sort for web-proxy url-list_entries.
---

# fmgdevice_webproxy_urllist_entries_sort
Sort for web-proxy url-list_entries.

```hcl
resource "fmgdevice_webproxy_urllist_entries_sort" "test" {
	sortby        = "id"
