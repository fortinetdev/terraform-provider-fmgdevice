...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy6_apigateway_quic"
description: |-
  <i>This object will be purged after policy copy and install.</i> QUIC setting.
---

# fmgdevice_firewall_accessproxy6_apigateway_quic
<i>This object will be purged after policy copy and install.</i> QUIC setting.

~> This resource is a sub resource for variable `quic` of resource `fmgdevice_firewall_accessproxy6_apigateway`. Conflict and overwrite may occur if use both of them.
...
Firewall AccessProxy6ApiGatewayQuic can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_accessproxy6_apigateway_quic.labelname FirewallAccessProxy6ApiGatewayQuic
