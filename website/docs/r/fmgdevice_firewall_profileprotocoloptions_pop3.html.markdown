...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_profileprotocoloptions_pop3"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure POP3 protocol options.
---

# fmgdevice_firewall_profileprotocoloptions_pop3
<i>This object will be purged after policy copy and install.</i> Configure POP3 protocol options.

~> This resource is a sub resource for variable `pop3` of resource `fmgdevice_firewall_profileprotocoloptions`. Conflict and overwrite may occur if use both of them.
...
Firewall ProfileProtocolOptionsPop3 can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_profileprotocoloptions_pop3.labelname FirewallProfileProtocolOptionsPop3
