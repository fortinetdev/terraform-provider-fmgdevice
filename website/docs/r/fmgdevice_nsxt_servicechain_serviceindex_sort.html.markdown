...
subcategory: "NSXT"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_nsxt_servicechain_serviceindex_sort"
description: |-
  Sort for nsxt service-chain_service-index.
---

# fmgdevice_nsxt_servicechain_serviceindex_sort
Sort for nsxt service-chain_service-index.

```hcl
resource "fmgdevice_nsxt_servicechain_serviceindex_sort" "test" {
	sortby        = "id"
