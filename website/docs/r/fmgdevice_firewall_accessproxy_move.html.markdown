...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv4 access proxy.
---

# fmgdevice_firewall_accessproxy_move
<i>This object will be purged after policy copy and install.</i> Move IPv4 access proxy.
