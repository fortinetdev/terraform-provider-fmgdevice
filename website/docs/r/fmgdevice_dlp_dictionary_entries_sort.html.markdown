...
subcategory: "DLP"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_dictionary_entries_sort"
description: |-
  Sort for dlp dictionary_entries.
---

# fmgdevice_dlp_dictionary_entries_sort
Sort for dlp dictionary_entries.

```hcl
resource "fmgdevice_dlp_dictionary_entries_sort" "test" {
	sortby        = "id"
