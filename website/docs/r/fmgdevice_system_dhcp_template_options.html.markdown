...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_dhcp_template_options"
description: |-
  DHCP options.
---

# fmgdevice_system_dhcp_template_options
DHCP options.

~> This resource is a sub resource for variable `options` of resource `fmgdevice_system_dhcp_template`. Conflict and overwrite may occur if use both of them.
...
System DhcpTemplateOptions can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "template=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_system_dhcp_template_options.labelname {{fosid}}
