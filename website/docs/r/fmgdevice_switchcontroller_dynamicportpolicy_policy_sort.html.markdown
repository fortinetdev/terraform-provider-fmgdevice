...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_switchcontroller_dynamicportpolicy_policy_sort"
description: |-
  Sort for switch-controller dynamic-port-policy_policy.
---

# fmgdevice_switchcontroller_dynamicportpolicy_policy_sort
Sort for switch-controller dynamic-port-policy_policy.

```hcl
resource "fmgdevice_switchcontroller_dynamicportpolicy_policy_sort" "test" {
	sortby        = "name"
