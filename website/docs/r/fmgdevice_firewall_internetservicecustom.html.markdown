...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_internetservicecustom"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure custom Internet Services.
---

# fmgdevice_firewall_internetservicecustom
<i>This object will be purged after policy copy and install.</i> Configure custom Internet Services.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `entry`: `fmgdevice_firewall_internetservicecustom_entry`
...
$ terraform import fmgdevice_firewall_internetservicecustom.labelname {{name}}
