...
# fmgdevice_extensioncontroller_extenderprofile_wifi_radio1
Radio-1 config for Wi-Fi 2.4GHz

~> This resource is a sub resource for variable `radio_1` of resource `fmgdevice_extensioncontroller_extenderprofile_wifi`. Conflict and overwrite may occur if use both of them.
...
ExtensionController ExtenderProfileWifiRadio1 can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_extensioncontroller_extenderprofile_wifi_radio1.labelname ExtensionControllerExtenderProfileWifiRadio1
