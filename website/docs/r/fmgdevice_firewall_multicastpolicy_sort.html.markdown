...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_multicastpolicy_sort"
description: |-
  Sort for firewall multicast-policy.
---

# fmgdevice_firewall_multicastpolicy_sort
Sort for firewall multicast-policy.

```hcl
resource "fmgdevice_firewall_multicastpolicy_sort" "test" {
	sortby        = "id"
