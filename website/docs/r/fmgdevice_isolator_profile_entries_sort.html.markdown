...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_isolator_profile_entries_sort"
description: |-
  Sort for isolator profile_entries.
---

# fmgdevice_isolator_profile_entries_sort
Sort for isolator profile_entries.

```hcl
resource "fmgdevice_isolator_profile_entries_sort" "test" {
	sortby        = "id"
