...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_centralsnatmap_sort"
description: |-
  Sort for firewall central-snat-map.
---

# fmgdevice_firewall_centralsnatmap_sort
Sort for firewall central-snat-map.

```hcl
resource "fmgdevice_firewall_centralsnatmap_sort" "test" {
	sortby        = "policyid"
