...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxysshclientcert_sort"
description: |-
  Sort for firewall access-proxy-ssh-client-cert.
---

# fmgdevice_firewall_accessproxysshclientcert_sort
Sort for firewall access-proxy-ssh-client-cert.

```hcl
resource "fmgdevice_firewall_accessproxysshclientcert_sort" "test" {
	sortby        = "name"
