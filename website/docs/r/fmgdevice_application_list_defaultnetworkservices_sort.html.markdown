...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_application_list_defaultnetworkservices_sort"
description: |-
  Sort for application list_default-network-services.
---

# fmgdevice_application_list_defaultnetworkservices_sort
Sort for application list_default-network-services.

```hcl
resource "fmgdevice_application_list_defaultnetworkservices_sort" "test" {
	sortby        = "id"
