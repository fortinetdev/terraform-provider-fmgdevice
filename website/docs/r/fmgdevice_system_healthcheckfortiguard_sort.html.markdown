...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_healthcheckfortiguard_sort"
description: |-
  Sort for system health-check-fortiguard.
---

# fmgdevice_system_healthcheckfortiguard_sort
Sort for system health-check-fortiguard.

```hcl
resource "fmgdevice_system_healthcheckfortiguard_sort" "test" {
	sortby        = "name"
