...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_sort"
description: |-
  Sort for wireless-controller mpsk-profile_mpsk-group.
---

# fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_sort
Sort for wireless-controller mpsk-profile_mpsk-group.

```hcl
resource "fmgdevice_wirelesscontroller_mpskprofile_mpskgroup_sort" "test" {
	sortby        = "name"
