...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_webfilter_urlfilter_entries_sort"
description: |-
  Sort for webfilter urlfilter_entries.
---

# fmgdevice_webfilter_urlfilter_entries_sort
Sort for webfilter urlfilter_entries.

```hcl
resource "fmgdevice_webfilter_urlfilter_entries_sort" "test" {
	sortby        = "id"
