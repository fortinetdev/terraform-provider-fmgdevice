...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_vdomsflow"
description: |-
...
# fmgdevice_system_vdomsflow
Configure sFlow per VDOM to add or change the IP address and UDP port that FortiGate sFlow agents in this VDOM use to send sFlow datagrams to an sFlow collector.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `collectors`: `fmgdevice_system_vdomsflow_collectors`
...
```hcl
resource "fmgdevice_system_vdomsflow" "trname" {
...
* `vdom_sflow` - Enable/disable the sFlow configuration for the current VDOM. Valid values: `disable`, `enable`.
...
$ terraform import fmgdevice_system_vdomsflow.labelname SystemVdomSflow
