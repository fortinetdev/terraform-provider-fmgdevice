...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dnsfilter_domainfilter_entries_sort"
description: |-
  Sort for dnsfilter domain-filter_entries.
---

# fmgdevice_dnsfilter_domainfilter_entries_sort
Sort for dnsfilter domain-filter_entries.

```hcl
resource "fmgdevice_dnsfilter_domainfilter_entries_sort" "test" {
	sortby        = "id"
