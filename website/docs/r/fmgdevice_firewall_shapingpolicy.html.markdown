...
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure shaping policies.
---

# fmgdevice_firewall_shapingpolicy
<i>This object will be purged after policy copy and install.</i> Configure shaping policies.
...
$ terraform import fmgdevice_firewall_shapingpolicy.labelname {{fosid}}
