...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_vap_vlanname_sort"
description: |-
  Sort for wireless-controller vap_vlan-name.
---

# fmgdevice_wirelesscontroller_vap_vlanname_sort
Sort for wireless-controller vap_vlan-name.

```hcl
resource "fmgdevice_wirelesscontroller_vap_vlanname_sort" "test" {
	sortby        = "name"
