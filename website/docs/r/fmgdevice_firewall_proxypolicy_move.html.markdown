...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_proxypolicy_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move proxy policies.
---

# fmgdevice_firewall_proxypolicy_move
<i>This object will be purged after policy copy and install.</i> Move proxy policies.
