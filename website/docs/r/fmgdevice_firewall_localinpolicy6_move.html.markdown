...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_localinpolicy6_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move user defined IPv6 local-in policies.
---

# fmgdevice_firewall_localinpolicy6_move
<i>This object will be purged after policy copy and install.</i> Move user defined IPv6 local-in policies.
