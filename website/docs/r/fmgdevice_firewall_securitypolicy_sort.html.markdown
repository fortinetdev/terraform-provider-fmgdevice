...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_securitypolicy_sort"
description: |-
  Sort for firewall security-policy.
---

# fmgdevice_firewall_securitypolicy_sort
Sort for firewall security-policy.

```hcl
resource "fmgdevice_firewall_securitypolicy_sort" "test" {
	sortby        = "policyid"
