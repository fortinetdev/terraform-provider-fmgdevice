...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdwan_members_sort"
description: |-
  Sort for system sdwan_members.
---

# fmgdevice_system_sdwan_members_sort
Sort for system sdwan_members.

```hcl
resource "fmgdevice_system_sdwan_members_sort" "test" {
	sortby        = "seq-num"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "seq-num".
...
* `sortby` - Sort security policies by the value, it currently supports "seq-num".
