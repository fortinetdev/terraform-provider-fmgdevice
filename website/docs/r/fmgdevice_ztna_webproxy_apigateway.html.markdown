...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_ztna_webproxy_apigateway"
description: |-
  Set IPv4 API Gateway.
---

# fmgdevice_ztna_webproxy_apigateway
Set IPv4 API Gateway.

~> This resource is a sub resource for variable `api_gateway` of resource `fmgdevice_ztna_webproxy`. Conflict and overwrite may occur if use both of them.
The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `quic`: `fmgdevice_ztna_webproxy_apigateway_quic`
>- `realservers`: `fmgdevice_ztna_webproxy_apigateway_realservers`
>- `ssl_cipher_suites`: `fmgdevice_ztna_webproxy_apigateway_sslciphersuites`
...
Ztna WebProxyApiGateway can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE", "web_proxy=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_ztna_webproxy_apigateway.labelname {{fosid}}
