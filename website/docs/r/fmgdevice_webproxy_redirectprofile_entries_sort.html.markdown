...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_webproxy_redirectprofile_entries_sort"
description: |-
  Sort for web-proxy redirect-profile_entries.
---

# fmgdevice_webproxy_redirectprofile_entries_sort
Sort for web-proxy redirect-profile_entries.

```hcl
resource "fmgdevice_webproxy_redirectprofile_entries_sort" "test" {
	sortby        = "id"
