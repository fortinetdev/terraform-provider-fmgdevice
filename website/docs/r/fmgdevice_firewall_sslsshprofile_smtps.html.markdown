...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_sslsshprofile_smtps"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure SMTPS options.
---

# fmgdevice_firewall_sslsshprofile_smtps
<i>This object will be purged after policy copy and install.</i> Configure SMTPS options.

~> This resource is a sub resource for variable `smtps` of resource `fmgdevice_firewall_sslsshprofile`. Conflict and overwrite may occur if use both of them.
...
Firewall SslSshProfileSmtps can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_sslsshprofile_smtps.labelname FirewallSslSshProfileSmtps
