...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy_apigateway"
description: |-
  <i>This object will be purged after policy copy and install.</i> Set IPv4 API Gateway.
---

# fmgdevice_firewall_accessproxy_apigateway
<i>This object will be purged after policy copy and install.</i> Set IPv4 API Gateway.

~> This resource is a sub resource for variable `api_gateway` of resource `fmgdevice_firewall_accessproxy`. Conflict and overwrite may occur if use both of them.
The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `quic`: `fmgdevice_firewall_accessproxy_apigateway_quic`
>- `realservers`: `fmgdevice_firewall_accessproxy_apigateway_realservers`
>- `ssl_cipher_suites`: `fmgdevice_firewall_accessproxy_apigateway_sslciphersuites`
...
Firewall AccessProxyApiGateway can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE", "access_proxy=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_firewall_accessproxy_apigateway.labelname {{fosid}}
