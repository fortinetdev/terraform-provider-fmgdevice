...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_ztna_webproxy_apigateway6"
description: |-
  Set IPv6 API Gateway.
---

# fmgdevice_ztna_webproxy_apigateway6
Set IPv6 API Gateway.

~> This resource is a sub resource for variable `api_gateway6` of resource `fmgdevice_ztna_webproxy`. Conflict and overwrite may occur if use both of them.
The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `quic`: `fmgdevice_ztna_webproxy_apigateway6_quic`
>- `realservers`: `fmgdevice_ztna_webproxy_apigateway6_realservers`
>- `ssl_cipher_suites`: `fmgdevice_ztna_webproxy_apigateway6_sslciphersuites`
...
Ztna WebProxyApiGateway6 can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE", "web_proxy=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_ztna_webproxy_apigateway6.labelname {{fosid}}
