...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ssl_web_portal_splitdns_sort"
description: |-
  Sort for vpn ssl_web_portal_split-dns.
---

# fmgdevice_vpn_ssl_web_portal_splitdns_sort
Sort for vpn ssl_web_portal_split-dns.

```hcl
resource "fmgdevice_vpn_ssl_web_portal_splitdns_sort" "test" {
	sortby        = "id"
