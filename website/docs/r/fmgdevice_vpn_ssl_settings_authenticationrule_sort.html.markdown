...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_ssl_settings_authenticationrule_sort"
description: |-
  Sort for vpn ssl_settings_authentication-rule.
---

# fmgdevice_vpn_ssl_settings_authenticationrule_sort
Sort for vpn ssl_settings_authentication-rule.

```hcl
resource "fmgdevice_vpn_ssl_settings_authenticationrule_sort" "test" {
	sortby        = "id"
