...
subcategory: "DLP"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_sensor_filter_sort"
description: |-
  Sort for dlp sensor_filter.
---

# fmgdevice_dlp_sensor_filter_sort
Sort for dlp sensor_filter.

```hcl
resource "fmgdevice_dlp_sensor_filter_sort" "test" {
	sortby        = "id"
