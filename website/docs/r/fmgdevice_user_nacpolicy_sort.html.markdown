...
subcategory: "User"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_user_nacpolicy_sort"
description: |-
  Sort for user nac-policy.
---

# fmgdevice_user_nacpolicy_sort
Sort for user nac-policy.

```hcl
resource "fmgdevice_user_nacpolicy_sort" "test" {
	sortby        = "name"
