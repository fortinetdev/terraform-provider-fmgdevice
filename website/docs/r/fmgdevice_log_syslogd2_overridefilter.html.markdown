...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_syslogd2_overridefilter"
description: |-
  Override filters for remote system server.
---

# fmgdevice_log_syslogd2_overridefilter
Override filters for remote system server.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `free_style`: `fmgdevice_log_syslogd2_overridefilter_freestyle`
...
```hcl
resource "fmgdevice_log_syslogd2_overridefilter" "trname" {
  anomaly         = "disable"
...
Log Syslogd2OverrideFilter can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_syslogd2_overridefilter.labelname LogSyslogd2OverrideFilter
