...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_externalaccountlist_sort"
description: |-
  Sort for system sdn-connector_external-account-list.
---

# fmgdevice_system_sdnconnector_externalaccountlist_sort
Sort for system sdn-connector_external-account-list.

```hcl
resource "fmgdevice_system_sdnconnector_externalaccountlist_sort" "test" {
	sortby        = "role-arn"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "role-arn".
...
* `sortby` - Sort security policies by the value, it currently supports "role-arn".
