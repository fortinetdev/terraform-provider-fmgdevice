...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_extensioncontroller_extenderprofile_lanextension_backhaul_sort"
description: |-
  Sort for extension-controller extender-profile_lan-extension_backhaul.
---

# fmgdevice_extensioncontroller_extenderprofile_lanextension_backhaul_sort
Sort for extension-controller extender-profile_lan-extension_backhaul.

```hcl
resource "fmgdevice_extensioncontroller_extenderprofile_lanextension_backhaul_sort" "test" {
	sortby        = "name"
