...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_authentication_rule_sort"
description: |-
  Sort for authentication rule.
---

# fmgdevice_authentication_rule_sort
Sort for authentication rule.

```hcl
resource "fmgdevice_authentication_rule_sort" "test" {
	sortby        = "name"
