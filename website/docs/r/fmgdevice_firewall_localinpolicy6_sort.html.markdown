...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_localinpolicy6_sort"
description: |-
  Sort for firewall local-in-policy6.
---

# fmgdevice_firewall_localinpolicy6_sort
Sort for firewall local-in-policy6.

```hcl
resource "fmgdevice_firewall_localinpolicy6_sort" "test" {
	sortby        = "policyid"
