...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_policy_sort"
description: |-
  Sort for firewall policy.
---

# fmgdevice_firewall_policy_sort
Sort for firewall policy.

```hcl
resource "fmgdevice_firewall_policy_sort" "test" {
	sortby        = "policyid"
