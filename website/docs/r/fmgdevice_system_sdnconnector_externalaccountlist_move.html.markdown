...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_externalaccountlist_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move AWS external account list.
---

# fmgdevice_system_sdnconnector_externalaccountlist_move
<i>This object will be purged after policy copy and install.</i> Move AWS external account list.
