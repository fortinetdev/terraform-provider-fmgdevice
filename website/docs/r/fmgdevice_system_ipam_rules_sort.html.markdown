...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_ipam_rules_sort"
description: |-
  Sort for system ipam_rules.
---

# fmgdevice_system_ipam_rules_sort
Sort for system ipam_rules.

```hcl
resource "fmgdevice_system_ipam_rules_sort" "test" {
	sortby        = "name"
