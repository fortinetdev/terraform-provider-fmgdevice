...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_service_category_sort"
description: |-
  Sort for firewall service_category.
---

# fmgdevice_firewall_service_category_sort
Sort for firewall service_category.

```hcl
resource "fmgdevice_firewall_service_category_sort" "test" {
	sortby        = "name"
