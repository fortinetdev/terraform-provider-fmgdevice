...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_profileprotocoloptions_ftp"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure FTP protocol options.
---

# fmgdevice_firewall_profileprotocoloptions_ftp
<i>This object will be purged after policy copy and install.</i> Configure FTP protocol options.

~> This resource is a sub resource for variable `ftp` of resource `fmgdevice_firewall_profileprotocoloptions`. Conflict and overwrite may occur if use both of them.
...
Firewall ProfileProtocolOptionsFtp can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_profileprotocoloptions_ftp.labelname FirewallProfileProtocolOptionsFtp
