...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_compartmentlist_sort"
description: |-
  Sort for system sdn-connector_compartment-list.
---

# fmgdevice_system_sdnconnector_compartmentlist_sort
Sort for system sdn-connector_compartment-list.

```hcl
resource "fmgdevice_system_sdnconnector_compartmentlist_sort" "test" {
	sortby        = "compartment-id"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "compartment-id".
...
* `sortby` - Sort security policies by the value, it currently supports "compartment-id".
