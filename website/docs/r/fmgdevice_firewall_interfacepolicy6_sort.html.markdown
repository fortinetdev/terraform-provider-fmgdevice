...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_interfacepolicy6_sort"
description: |-
  Sort for firewall interface-policy6.
---

# fmgdevice_firewall_interfacepolicy6_sort
Sort for firewall interface-policy6.

```hcl
resource "fmgdevice_firewall_interfacepolicy6_sort" "test" {
	sortby        = "policyid"
