...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_voip_profile"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure VoIP profiles.
---

# fmgdevice_voip_profile
<i>This object will be purged after policy copy and install.</i> Configure VoIP profiles.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `msrp`: `fmgdevice_voip_profile_msrp`
>- `sccp`: `fmgdevice_voip_profile_sccp`
>- `sip`: `fmgdevice_voip_profile_sip`
...
$ terraform import fmgdevice_voip_profile.labelname {{name}}
