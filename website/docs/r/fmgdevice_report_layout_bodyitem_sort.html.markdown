...
subcategory: "Report"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_report_layout_bodyitem_sort"
description: |-
  Sort for report layout_body-item.
---

# fmgdevice_report_layout_bodyitem_sort
Sort for report layout_body-item.

```hcl
resource "fmgdevice_report_layout_bodyitem_sort" "test" {
	sortby        = "id"
