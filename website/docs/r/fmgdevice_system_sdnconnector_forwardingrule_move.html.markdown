...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_sdnconnector_forwardingrule_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move GCP forwarding rule.
---

# fmgdevice_system_sdnconnector_forwardingrule_move
<i>This object will be purged after policy copy and install.</i> Move GCP forwarding rule.
