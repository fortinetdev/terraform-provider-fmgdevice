...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort"
description: |-
  Sort for wireless-controller access-control-list_layer3-ipv4-rules.
---

# fmgdevice_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort
Sort for wireless-controller access-control-list_layer3-ipv4-rules.

```hcl
resource "fmgdevice_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort" "test" {
	sortby        = "rule-id"
