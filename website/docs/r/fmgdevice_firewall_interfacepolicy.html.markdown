...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_interfacepolicy"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure IPv4 interface policies.
---

# fmgdevice_firewall_interfacepolicy
<i>This object will be purged after policy copy and install.</i> Configure IPv4 interface policies.
...
$ terraform import fmgdevice_firewall_interfacepolicy.labelname {{policyid}}
