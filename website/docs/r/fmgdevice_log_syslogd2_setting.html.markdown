...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_syslogd2_setting"
description: |-
  Global settings for remote syslog server.
---

# fmgdevice_log_syslogd2_setting
Global settings for remote syslog server.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `custom_field_name`: `fmgdevice_log_syslogd2_setting_customfieldname`
>- `log_templates`: `fmgdevice_log_syslogd2_setting_logtemplates`
...
```hcl
resource "fmgdevice_log_syslogd2_setting" "trname" {
...
Log Syslogd2Setting can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_syslogd2_setting.labelname LogSyslogd2Setting
