...
subcategory: "Router"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_router_policy6_sort"
description: |-
  Sort for router policy6.
---

# fmgdevice_router_policy6_sort
Sort for router policy6.

```hcl
resource "fmgdevice_router_policy6_sort" "test" {
	sortby        = "seq-num"
