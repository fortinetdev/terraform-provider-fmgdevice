...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy_sort"
description: |-
  Sort for firewall access-proxy.
---

# fmgdevice_firewall_accessproxy_sort
Sort for firewall access-proxy.

```hcl
resource "fmgdevice_firewall_accessproxy_sort" "test" {
	sortby        = "name"
