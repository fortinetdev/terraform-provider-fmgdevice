...
subcategory: "DLP"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dlp_sensor_entries_sort"
description: |-
  Sort for dlp sensor_entries.
---

# fmgdevice_dlp_sensor_entries_sort
Sort for dlp sensor_entries.

```hcl
resource "fmgdevice_dlp_sensor_entries_sort" "test" {
	sortby        = "id"
