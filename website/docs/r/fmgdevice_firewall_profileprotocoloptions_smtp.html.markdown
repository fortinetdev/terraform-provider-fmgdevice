...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_profileprotocoloptions_smtp"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure SMTP protocol options.
---

# fmgdevice_firewall_profileprotocoloptions_smtp
<i>This object will be purged after policy copy and install.</i> Configure SMTP protocol options.

~> This resource is a sub resource for variable `smtp` of resource `fmgdevice_firewall_profileprotocoloptions`. Conflict and overwrite may occur if use both of them.
...
Firewall ProfileProtocolOptionsSmtp can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_profileprotocoloptions_smtp.labelname FirewallProfileProtocolOptionsSmtp
