...
subcategory: "VPN"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_vpn_kmipserver_serverlist_sort"
description: |-
  Sort for vpn kmip-server_server-list.
---

# fmgdevice_vpn_kmipserver_serverlist_sort
Sort for vpn kmip-server_server-list.

```hcl
resource "fmgdevice_vpn_kmipserver_serverlist_sort" "test" {
	sortby        = "id"
