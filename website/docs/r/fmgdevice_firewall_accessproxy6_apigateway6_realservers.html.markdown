...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxy6_apigateway6_realservers"
description: |-
...
# fmgdevice_firewall_accessproxy6_apigateway6_realservers
<i>This object will be purged after policy copy and install.</i> Select the real servers that this Access Proxy will distribute traffic to.

~> This resource is a sub resource for variable `realservers` of resource `fmgdevice_firewall_accessproxy6_apigateway6`. Conflict and overwrite may occur if use both of them.
...
Firewall AccessProxy6ApiGateway6Realservers can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_accessproxy6_apigateway6_realservers.labelname {{fosid}}
