...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_bonjourprofile_policylist_sort"
description: |-
  Sort for wireless-controller bonjour-profile_policy-list.
---

# fmgdevice_wirelesscontroller_bonjourprofile_policylist_sort
Sort for wireless-controller bonjour-profile_policy-list.

```hcl
resource "fmgdevice_wirelesscontroller_bonjourprofile_policylist_sort" "test" {
	sortby        = "policy-id"
...
* `sortby` - (Required) Sort security policies by the value, it currently supports "policy-id".
...
* `sortby` - Sort security policies by the value, it currently supports "policy-id".
