...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_fortianalyzer2_setting"
description: |-
...
```hcl
resource "fmgdevice_log_fortianalyzer2_setting" "trname" {
  __change_ip              = 10
...
Log Fortianalyzer2Setting can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_fortianalyzer2_setting.labelname LogFortianalyzer2Setting
