...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_dospolicy6_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move IPv6 DoS policies.
---

# fmgdevice_firewall_dospolicy6_move
<i>This object will be purged after policy copy and install.</i> Move IPv6 DoS policies.
