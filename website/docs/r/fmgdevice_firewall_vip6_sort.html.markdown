...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_vip6_sort"
description: |-
  Sort for firewall vip6.
---

# fmgdevice_firewall_vip6_sort
Sort for firewall vip6.

```hcl
resource "fmgdevice_firewall_vip6_sort" "test" {
	sortby        = "name"
