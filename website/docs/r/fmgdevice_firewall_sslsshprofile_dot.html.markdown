...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_sslsshprofile_dot"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure DNS over TLS options.
---

# fmgdevice_firewall_sslsshprofile_dot
<i>This object will be purged after policy copy and install.</i> Configure DNS over TLS options.

~> This resource is a sub resource for variable `dot` of resource `fmgdevice_firewall_sslsshprofile`. Conflict and overwrite may occur if use both of them.
...
Firewall SslSshProfileDot can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_firewall_sslsshprofile_dot.labelname FirewallSslSshProfileDot
