...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_accessproxysshclientcert_move"
description: |-
  <i>This object will be purged after policy copy and install.</i> Move Access Proxy SSH client certificate.
---

# fmgdevice_firewall_accessproxysshclientcert_move
<i>This object will be purged after policy copy and install.</i> Move Access Proxy SSH client certificate.
