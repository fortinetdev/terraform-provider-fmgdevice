...
subcategory: "Router"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_router_policy_sort"
description: |-
  Sort for router policy.
---

# fmgdevice_router_policy_sort
Sort for router policy.

```hcl
resource "fmgdevice_router_policy_sort" "test" {
	sortby        = "seq-num"
