...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_videofilter_profile_fortiguardcategory_filters_move"
description: |-
  <i>This object will be purged after policy copy and install.</i>
---

# fmgdevice_videofilter_profile_fortiguardcategory_filters_move
<i>This object will be purged after policy copy and install.</i>
