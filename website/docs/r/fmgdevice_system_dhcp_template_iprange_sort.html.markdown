...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_dhcp_template_iprange_sort"
description: |-
  Sort for system dhcp_template_ip-range.
---

# fmgdevice_system_dhcp_template_iprange_sort
Sort for system dhcp_template_ip-range.

```hcl
resource "fmgdevice_system_dhcp_template_iprange_sort" "test" {
	sortby        = "id"
