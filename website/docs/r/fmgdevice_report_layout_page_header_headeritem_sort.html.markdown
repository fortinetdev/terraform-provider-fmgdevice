...
subcategory: "Report"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_report_layout_page_header_headeritem_sort"
description: |-
  Sort for report layout_page_header_header-item.
---

# fmgdevice_report_layout_page_header_headeritem_sort
Sort for report layout_page_header_header-item.

```hcl
resource "fmgdevice_report_layout_page_header_headeritem_sort" "test" {
	sortby        = "id"
