...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_ttlpolicy_sort"
description: |-
  Sort for firewall ttl-policy.
---

# fmgdevice_firewall_ttlpolicy_sort
Sort for firewall ttl-policy.

```hcl
resource "fmgdevice_firewall_ttlpolicy_sort" "test" {
	sortby        = "id"
