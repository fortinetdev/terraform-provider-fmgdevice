...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_wirelesscontroller_apcfgprofile_commandlist_sort"
description: |-
  Sort for wireless-controller apcfg-profile_command-list.
---

# fmgdevice_wirelesscontroller_apcfgprofile_commandlist_sort
Sort for wireless-controller apcfg-profile_command-list.

```hcl
resource "fmgdevice_wirelesscontroller_apcfgprofile_commandlist_sort" "test" {
	sortby        = "id"
