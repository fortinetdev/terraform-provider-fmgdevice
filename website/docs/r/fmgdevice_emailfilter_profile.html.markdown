...
>- `msn_hotmail`: `fmgdevice_emailfilter_profile_msnhotmail`
>- `other_webmails`: `fmgdevice_emailfilter_profile_otherwebmails`
>- `pop3`: `fmgdevice_emailfilter_profile_pop3`
>- `smtp`: `fmgdevice_emailfilter_profile_smtp`
...
* `name` - Profile name.
* `options` - Options. Valid values: `bannedword`, `spamfsip`, `spamfssubmit`, `spamfschksum`, `spamfsurl`, `spamhelodns`, `spamraddrdns`, `spamrbl`, `spamhdrcheck`, `spamfsphish`, `spambal`.
...
$ terraform import fmgdevice_emailfilter_profile.labelname {{name}}
