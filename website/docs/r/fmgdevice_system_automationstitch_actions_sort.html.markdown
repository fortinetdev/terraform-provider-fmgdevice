...
subcategory: "System"
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_system_automationstitch_actions_sort"
description: |-
  Sort for system automation-stitch_actions.
---

# fmgdevice_system_automationstitch_actions_sort
Sort for system automation-stitch_actions.

```hcl
resource "fmgdevice_system_automationstitch_actions_sort" "test" {
	sortby        = "id"
