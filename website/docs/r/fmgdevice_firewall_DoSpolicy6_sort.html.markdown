...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_firewall_DoSpolicy6_sort"
description: |-
  Sort for firewall DoS-policy6.
---

# fmgdevice_firewall_DoSpolicy6_sort
Sort for firewall DoS-policy6.

```hcl
resource "fmgdevice_firewall_DoSpolicy6_sort" "test" {
	sortby        = "policyid"
