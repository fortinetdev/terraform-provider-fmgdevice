...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_extensioncontroller_extenderprofile_wifi_radio2"
description: |-
  Radio-2 config for Wi-Fi 5GHz
---

# fmgdevice_extensioncontroller_extenderprofile_wifi_radio2
Radio-2 config for Wi-Fi 5GHz

~> This resource is a sub resource for variable `radio_2` of resource `fmgdevice_extensioncontroller_extenderprofile_wifi`. Conflict and overwrite may occur if use both of them.
...
ExtensionController ExtenderProfileWifiRadio2 can be imported using any of these accepted formats:
```
...
$ terraform import fmgdevice_extensioncontroller_extenderprofile_wifi_radio2.labelname ExtensionControllerExtenderProfileWifiRadio2
