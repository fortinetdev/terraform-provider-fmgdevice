...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_nulldevice_filter"
description: |-
  Filters for null device logging.
---

# fmgdevice_log_nulldevice_filter
Filters for null device logging.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `free_style`: `fmgdevice_log_nulldevice_filter_freestyle`
...
```hcl
resource "fmgdevice_log_nulldevice_filter" "trname" {
  anomaly         = "enable"
...
Log NullDeviceFilter can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE", "device_vdom=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_nulldevice_filter.labelname LogNullDeviceFilter
