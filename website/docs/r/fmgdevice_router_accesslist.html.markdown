...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_router_accesslist"
description: |-
  Configure access lists.
---

# fmgdevice_router_accesslist
Configure access lists.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `rule`: `fmgdevice_router_accesslist_rule`
...
$ terraform import fmgdevice_router_accesslist.labelname {{name}}
