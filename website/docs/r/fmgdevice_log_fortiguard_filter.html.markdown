...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_log_fortiguard_filter"
description: |-
  Filters for FortiCloud.
---

# fmgdevice_log_fortiguard_filter
Filters for FortiCloud.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `free_style`: `fmgdevice_log_fortiguard_filter_freestyle`
...
```hcl
resource "fmgdevice_log_fortiguard_filter" "trname" {
  anomaly         = "enable"
...
Log FortiguardFilter can be imported using any of these accepted formats:
```
Set import_options = ["device_name=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fmgdevice_log_fortiguard_filter.labelname LogFortiguardFilter
