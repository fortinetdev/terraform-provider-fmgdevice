...
layout: "fmgdevice"
page_title: "FortiManager Device: fmgdevice_dnsfilter_profile"
description: |-
  <i>This object will be purged after policy copy and install.</i> Configure DNS domain filter profile.
---

# fmgdevice_dnsfilter_profile
<i>This object will be purged after policy copy and install.</i> Configure DNS domain filter profile.

~> The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `dns_translation`: `fmgdevice_dnsfilter_profile_dnstranslation`
>- `domain_filter`: `fmgdevice_dnsfilter_profile_domainfilter`
>- `ftgd_dns`: `fmgdevice_dnsfilter_profile_ftgddns`
...
* `youtube_restrict` - Set safe search for YouTube restriction level. Valid values: `strict`, `none`, `moderate`.
...
$ terraform import fmgdevice_dnsfilter_profile.labelname {{name}}
