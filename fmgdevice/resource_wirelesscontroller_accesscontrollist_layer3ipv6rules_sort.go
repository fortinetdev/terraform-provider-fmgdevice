...
func resourceWirelessControllerAccessControlListLayer3Ipv6RulesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate,
		Read:   resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortRead,
		Update: resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate,
		Delete: schema.Noop,
		...
		Schema: map[string]*schema.Schema{
			...
			"sortby": &schema.Schema{
				...
				ValidateFunc: func(val interface{}, key string) (warns []string, errs []error) {
					v := val.(string)
					availableOptions := []string{"rule-id"}
					var validValue bool
					...
					if !validValue {
						errs = append(errs, fmt.Errorf("%q must be one of the option of [\"rule-id\"], got: \"%v\"", key, v))
					}
					return
				},
			},
...
func resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWirelessControllerAccessControlListLayer3Ipv6RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WirelessControllerAccessControlListLayer3Ipv6Rules: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortRead(d, m)
}

func resourceWirelessControllerAccessControlListLayer3Ipv6RulesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWirelessControllerAccessControlListLayer3Ipv6RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WirelessControllerAccessControlListLayer3Ipv6Rules sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WirelessControllerAccessControlListLayer3Ipv6Rules List for (%s): %s", d.Id(), err)
		}
	} else {
