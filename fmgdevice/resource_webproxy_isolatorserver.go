...
func flattenWebProxyIsolatorServerFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWebProxyIsolatorServerFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWebProxyIsolatorServerFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWebProxyIsolatorServerUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWebProxyIsolatorServerIppool6(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func refreshObjectWebProxyIsolatorServer(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenWebProxyIsolatorServerFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "WebProxyIsolatorServer-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenWebProxyIsolatorServerFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "WebProxyIsolatorServer-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenWebProxyIsolatorServerFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "WebProxyIsolatorServer-FabricObjectSource"); ok {
	...
	if err = d.Set("uuid", flattenWebProxyIsolatorServerUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "WebProxyIsolatorServer-Uuid"); ok {
	...
	if err = d.Set("ippool6", flattenWebProxyIsolatorServerIppool6(o["ippool6"], d, "ippool6")); err != nil {
		if vv, ok := fortiAPIPatch(o["ippool6"], "WebProxyIsolatorServer-Ippool6"); ok {
...
func expandWebProxyIsolatorServerFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWebProxyIsolatorServerFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWebProxyIsolatorServerFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWebProxyIsolatorServerUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWebProxyIsolatorServerIppool6(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func getObjectWebProxyIsolatorServer(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandWebProxyIsolatorServerFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandWebProxyIsolatorServerFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandWebProxyIsolatorServerFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandWebProxyIsolatorServerUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
	...
	if v, ok := d.GetOk("ippool6"); ok || d.HasChange("ippool6") {
		t, err := expandWebProxyIsolatorServerIppool6(d, v, "ippool6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ippool6"] = t
