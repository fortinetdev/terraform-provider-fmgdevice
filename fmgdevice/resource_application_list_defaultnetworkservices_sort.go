...
func resourceApplicationListDefaultNetworkServicesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceApplicationListDefaultNetworkServicesSortCreateUpdate,
		Read:   resourceApplicationListDefaultNetworkServicesSortRead,
		Update: resourceApplicationListDefaultNetworkServicesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceApplicationListDefaultNetworkServicesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateApplicationListDefaultNetworkServicesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ApplicationListDefaultNetworkServices: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceApplicationListDefaultNetworkServicesSortRead(d, m)
}

func resourceApplicationListDefaultNetworkServicesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadApplicationListDefaultNetworkServicesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ApplicationListDefaultNetworkServices sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ApplicationListDefaultNetworkServices List for (%s): %s", d.Id(), err)
		}
	} else {
