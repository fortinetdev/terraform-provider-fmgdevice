...
func resourceWebfilterIpsUrlfilterSettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWebfilterIpsUrlfilterSetting(d, false)
	if err != nil {
	...
	_, err = c.UpdateWebfilterIpsUrlfilterSetting(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceWebfilterIpsUrlfilterSettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWebfilterIpsUrlfilterSetting(d, true)
...
func getObjectWebfilterIpsUrlfilterSetting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
