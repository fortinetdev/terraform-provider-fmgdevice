...
func resourceLogSyslogd4SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd4Setting(d, false)
	if err != nil {
...
func resourceLogSyslogd4SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd4Setting(d, true)
...
func flattenLogSyslogd4SettingCustomLogFormat(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func refreshObjectLogSyslogd4Setting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("custom_log_format", flattenLogSyslogd4SettingCustomLogFormat(o["custom-log-format"], d, "custom_log_format")); err != nil {
		if vv, ok := fortiAPIPatch(o["custom-log-format"], "LogSyslogd4Setting-CustomLogFormat"); ok {
	...
	if err = d.Set("vrf_select", flattenLogSyslogd4SettingVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "LogSyslogd4Setting-VrfSelect"); ok {
...
func expandLogSyslogd4SettingCustomLogFormat(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func getObjectLogSyslogd4Setting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("custom_log_format"); ok || d.HasChange("custom_log_format") {
		t, err := expandLogSyslogd4SettingCustomLogFormat(d, v, "custom_log_format")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandLogSyslogd4SettingVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
