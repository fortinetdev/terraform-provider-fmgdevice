...
func flattenLogSyslogd3OverrideFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogSyslogd3OverrideFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd3OverrideFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogSyslogd3OverrideFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogSyslogd3OverrideFilter-Debug"); ok {
	...
	if err = d.Set("http_transaction", flattenLogSyslogd3OverrideFilterHttpTransaction(o["http-transaction"], d, "http_transaction")); err != nil {
		if vv, ok := fortiAPIPatch(o["http-transaction"], "LogSyslogd3OverrideFilter-HttpTransaction"); ok {
...
func expandLogSyslogd3OverrideFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogSyslogd3OverrideFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd3OverrideFilter(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogSyslogd3OverrideFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
	...
	if v, ok := d.GetOk("http_transaction"); ok || d.HasChange("http_transaction") {
		t, err := expandLogSyslogd3OverrideFilterHttpTransaction(d, v, "http_transaction")
		if err != nil {
			return &obj, err
		} else if t != nil {
