...
func resourceVpnSslWebUserGroupBookmarkBookmarksSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVpnSslWebUserGroupBookmarkBookmarksSortCreateUpdate,
		Read:   resourceVpnSslWebUserGroupBookmarkBookmarksSortRead,
		Update: resourceVpnSslWebUserGroupBookmarkBookmarksSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVpnSslWebUserGroupBookmarkBookmarksSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVpnSslWebUserGroupBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VpnSslWebUserGroupBookmarkBookmarks: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVpnSslWebUserGroupBookmarkBookmarksSortRead(d, m)
}

func resourceVpnSslWebUserGroupBookmarkBookmarksSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVpnSslWebUserGroupBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VpnSslWebUserGroupBookmarkBookmarks sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VpnSslWebUserGroupBookmarkBookmarks List for (%s): %s", d.Id(), err)
		}
	} else {
