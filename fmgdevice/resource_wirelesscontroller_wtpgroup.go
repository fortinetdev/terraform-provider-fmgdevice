...
func resourceWirelessControllerWtpGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerWtpGroup(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerWtpGroup(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerWtpGroupUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerWtpGroup(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerWtpGroup resource: %v", err)
	}
...
func resourceWirelessControllerWtpGroupDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerWtpGroup(mkey, paradict, wsParams)
	if err != nil {
