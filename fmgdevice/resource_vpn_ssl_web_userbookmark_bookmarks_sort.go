...
func resourceVpnSslWebUserBookmarkBookmarksSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVpnSslWebUserBookmarkBookmarksSortCreateUpdate,
		Read:   resourceVpnSslWebUserBookmarkBookmarksSortRead,
		Update: resourceVpnSslWebUserBookmarkBookmarksSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVpnSslWebUserBookmarkBookmarksSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVpnSslWebUserBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VpnSslWebUserBookmarkBookmarks: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVpnSslWebUserBookmarkBookmarksSortRead(d, m)
}

func resourceVpnSslWebUserBookmarkBookmarksSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVpnSslWebUserBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VpnSslWebUserBookmarkBookmarks sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VpnSslWebUserBookmarkBookmarks List for (%s): %s", d.Id(), err)
		}
	} else {
