...
func resourceExtensionControllerExtenderProfileLanExtensionBackhaulSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate,
		Read:   resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortRead,
		Update: resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateExtensionControllerExtenderProfileLanExtensionBackhaulSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ExtensionControllerExtenderProfileLanExtensionBackhaul: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortRead(d, m)
}

func resourceExtensionControllerExtenderProfileLanExtensionBackhaulSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadExtensionControllerExtenderProfileLanExtensionBackhaulSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ExtensionControllerExtenderProfileLanExtensionBackhaul sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ExtensionControllerExtenderProfileLanExtensionBackhaul List for (%s): %s", d.Id(), err)
		}
	} else {
