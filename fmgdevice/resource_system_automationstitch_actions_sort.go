...
func resourceSystemAutomationStitchActionsSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceSystemAutomationStitchActionsSortCreateUpdate,
		Read:   resourceSystemAutomationStitchActionsSortRead,
		Update: resourceSystemAutomationStitchActionsSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceSystemAutomationStitchActionsSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateSystemAutomationStitchActionsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting SystemAutomationStitchActions: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceSystemAutomationStitchActionsSortRead(d, m)
}

func resourceSystemAutomationStitchActionsSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadSystemAutomationStitchActionsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading SystemAutomationStitchActions sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading SystemAutomationStitchActions List for (%s): %s", d.Id(), err)
		}
	} else {
