...
func resourceWirelessControllerHotspot20IconCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerHotspot20Icon(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerHotspot20Icon(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerHotspot20IconUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerHotspot20Icon(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerHotspot20Icon resource: %v", err)
	}
...
func resourceWirelessControllerHotspot20IconDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerHotspot20Icon(mkey, paradict, wsParams)
	if err != nil {
