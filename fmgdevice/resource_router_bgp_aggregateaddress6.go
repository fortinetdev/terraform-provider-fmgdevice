...
func resourceRouterBgpAggregateAddress6Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateRouterBgpAggregateAddress6(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		v, err := c.CreateRouterBgpAggregateAddress6(obj, paradict, wsParams)
		if err != nil {
...
func resourceRouterBgpAggregateAddress6Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteRouterBgpAggregateAddress6(mkey, paradict, wsParams)
	if err != nil {
