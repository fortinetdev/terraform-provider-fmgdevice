...
func resourceVpnIpsecFecMappingsSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVpnIpsecFecMappingsSortCreateUpdate,
		Read:   resourceVpnIpsecFecMappingsSortRead,
		Update: resourceVpnIpsecFecMappingsSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVpnIpsecFecMappingsSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVpnIpsecFecMappingsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VpnIpsecFecMappings: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVpnIpsecFecMappingsSortRead(d, m)
}

func resourceVpnIpsecFecMappingsSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVpnIpsecFecMappingsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VpnIpsecFecMappings sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VpnIpsecFecMappings List for (%s): %s", d.Id(), err)
		}
	} else {
