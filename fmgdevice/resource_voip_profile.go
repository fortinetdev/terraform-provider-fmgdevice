...
// Description: <i>This object will be purged after policy copy and install.</i> Configure VoIP profiles.
...
func resourceVoipProfileCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadVoipProfile(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateVoipProfile(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateVoipProfile(obj, paradict, wsParams)
		if err != nil {
...
func resourceVoipProfileUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateVoipProfile(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating VoipProfile resource: %v", err)
	}
...
func resourceVoipProfileDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteVoipProfile(mkey, paradict, wsParams)
	if err != nil {
...
func flattenVoipProfileFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileFeatureSet(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileMsrp(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	if _, ok := i["log-violations"]; ok {
		result["log_violations"] = flattenVoipProfileMsrpLogViolations(i["log-violations"], d, pre_append)
	}

	pre_append = pre + ".0." + "max_msg_size"
	if _, ok := i["max-msg-size"]; ok {
		result["max_msg_size"] = flattenVoipProfileMsrpMaxMsgSize(i["max-msg-size"], d, pre_append)
	}

	pre_append = pre + ".0." + "max_msg_size_action"
	if _, ok := i["max-msg-size-action"]; ok {
		result["max_msg_size_action"] = flattenVoipProfileMsrpMaxMsgSizeAction(i["max-msg-size-action"], d, pre_append)
	}

	pre_append = pre + ".0." + "status"
	if _, ok := i["status"]; ok {
		result["status"] = flattenVoipProfileMsrpStatus(i["status"], d, pre_append)
	}
...
func flattenVoipProfileMsrpLogViolations(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileMsrpMaxMsgSize(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileMsrpMaxMsgSizeAction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileMsrpStatus(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSip(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	if _, ok := i["ack-rate-track"]; ok {
		result["ack_rate_track"] = flattenVoipProfileSipAckRateTrack(i["ack-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["bye-rate-track"]; ok {
		result["bye_rate_track"] = flattenVoipProfileSipByeRateTrack(i["bye-rate-track"], d, pre_append)
	}

	pre_append = pre + ".0." + "call_id_regex"
	if _, ok := i["call-id-regex"]; ok {
		result["call_id_regex"] = flattenVoipProfileSipCallIdRegex(i["call-id-regex"], d, pre_append)
	}
	...
	if _, ok := i["cancel-rate-track"]; ok {
		result["cancel_rate_track"] = flattenVoipProfileSipCancelRateTrack(i["cancel-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["content-type-regex"]; ok {
		result["content_type_regex"] = flattenVoipProfileSipContentTypeRegex(i["content-type-regex"], d, pre_append)
	}
	...
	if _, ok := i["info-rate-track"]; ok {
		result["info_rate_track"] = flattenVoipProfileSipInfoRateTrack(i["info-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["invite-rate-track"]; ok {
		result["invite_rate_track"] = flattenVoipProfileSipInviteRateTrack(i["invite-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["malformed-header-no-proxy-require"]; ok {
		result["malformed_header_no_proxy_require"] = flattenVoipProfileSipMalformedHeaderNoProxyRequire(i["malformed-header-no-proxy-require"], d, pre_append)
	}

	pre_append = pre + ".0." + "malformed_header_no_require"
	if _, ok := i["malformed-header-no-require"]; ok {
		result["malformed_header_no_require"] = flattenVoipProfileSipMalformedHeaderNoRequire(i["malformed-header-no-require"], d, pre_append)
	}
	...
	if _, ok := i["message-rate-track"]; ok {
		result["message_rate_track"] = flattenVoipProfileSipMessageRateTrack(i["message-rate-track"], d, pre_append)
	}

	pre_append = pre + ".0." + "nat_port_range"
	if _, ok := i["nat-port-range"]; ok {
		result["nat_port_range"] = flattenVoipProfileSipNatPortRange(i["nat-port-range"], d, pre_append)
	}
	...
	if _, ok := i["notify-rate-track"]; ok {
		result["notify_rate_track"] = flattenVoipProfileSipNotifyRateTrack(i["notify-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["options-rate-track"]; ok {
		result["options_rate_track"] = flattenVoipProfileSipOptionsRateTrack(i["options-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["prack-rate-track"]; ok {
		result["prack_rate_track"] = flattenVoipProfileSipPrackRateTrack(i["prack-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["publish-rate-track"]; ok {
		result["publish_rate_track"] = flattenVoipProfileSipPublishRateTrack(i["publish-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["refer-rate-track"]; ok {
		result["refer_rate_track"] = flattenVoipProfileSipReferRateTrack(i["refer-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["register-rate-track"]; ok {
		result["register_rate_track"] = flattenVoipProfileSipRegisterRateTrack(i["register-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["subscribe-rate-track"]; ok {
		result["subscribe_rate_track"] = flattenVoipProfileSipSubscribeRateTrack(i["subscribe-rate-track"], d, pre_append)
	}
	...
	if _, ok := i["update-rate-track"]; ok {
		result["update_rate_track"] = flattenVoipProfileSipUpdateRateTrack(i["update-rate-track"], d, pre_append)
	}
...
func flattenVoipProfileSipAckRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipByeRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileSipCallIdRegex(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipCancelRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipContentTypeRegex(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipInfoRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipInviteRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipMalformedHeaderNoProxyRequire(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileSipMalformedHeaderNoRequire(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipMessageRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileSipNatPortRange(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipNotifyRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipOptionsRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipPrackRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipPublishRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipReferRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipRegisterRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipSubscribeRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenVoipProfileSipUpdateRateTrack(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenVoipProfileUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectVoipProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("comment", flattenVoipProfileComment(o["comment"], d, "comment")); err != nil {
		if vv, ok := fortiAPIPatch(o["comment"], "VoipProfile-Comment"); ok {
	...
	if err = d.Set("fabric_force_sync", flattenVoipProfileFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "VoipProfile-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenVoipProfileFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "VoipProfile-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenVoipProfileFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "VoipProfile-FabricObjectSource"); ok {
	...
	if err = d.Set("feature_set", flattenVoipProfileFeatureSet(o["feature-set"], d, "feature_set")); err != nil {
		if vv, ok := fortiAPIPatch(o["feature-set"], "VoipProfile-FeatureSet"); ok {
	...
	if isImportTable() {
		if err = d.Set("msrp", flattenVoipProfileMsrp(o["msrp"], d, "msrp")); err != nil {
			if vv, ok := fortiAPIPatch(o["msrp"], "VoipProfile-Msrp"); ok {
	...
	if err = d.Set("name", flattenVoipProfileName(o["name"], d, "name")); err != nil {
		if vv, ok := fortiAPIPatch(o["name"], "VoipProfile-Name"); ok {
	...
	if isImportTable() {
		if err = d.Set("sccp", flattenVoipProfileSccp(o["sccp"], d, "sccp")); err != nil {
			if vv, ok := fortiAPIPatch(o["sccp"], "VoipProfile-Sccp"); ok {
	...
	if isImportTable() {
		if err = d.Set("sip", flattenVoipProfileSip(o["sip"], d, "sip")); err != nil {
			if vv, ok := fortiAPIPatch(o["sip"], "VoipProfile-Sip"); ok {
	...
	if err = d.Set("uuid", flattenVoipProfileUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "VoipProfile-Uuid"); ok {
...
func expandVoipProfileFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileFeatureSet(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileMsrp(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["log-violations"], _ = expandVoipProfileMsrpLogViolations(d, i["log_violations"], pre_append)
	}
	pre_append = pre + ".0." + "max_msg_size"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["max-msg-size"], _ = expandVoipProfileMsrpMaxMsgSize(d, i["max_msg_size"], pre_append)
	}
	pre_append = pre + ".0." + "max_msg_size_action"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["max-msg-size-action"], _ = expandVoipProfileMsrpMaxMsgSizeAction(d, i["max_msg_size_action"], pre_append)
	}
	pre_append = pre + ".0." + "status"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["status"], _ = expandVoipProfileMsrpStatus(d, i["status"], pre_append)
	}

	return result, nil
}

func expandVoipProfileMsrpLogViolations(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileMsrpMaxMsgSize(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileMsrpMaxMsgSizeAction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileMsrpStatus(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSip(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "ack_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["ack-rate-track"], _ = expandVoipProfileSipAckRateTrack(d, i["ack_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "block_ack"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "bye_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["bye-rate-track"], _ = expandVoipProfileSipByeRateTrack(d, i["bye_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "call_id_regex"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["call-id-regex"], _ = expandVoipProfileSipCallIdRegex(d, i["call_id_regex"], pre_append)
	}
	pre_append = pre + ".0." + "call_keepalive"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "cancel_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["cancel-rate-track"], _ = expandVoipProfileSipCancelRateTrack(d, i["cancel_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "contact_fixup"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "content_type_regex"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["content-type-regex"], _ = expandVoipProfileSipContentTypeRegex(d, i["content_type_regex"], pre_append)
	}
	pre_append = pre + ".0." + "hnt_restrict_source_ip"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "info_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["info-rate-track"], _ = expandVoipProfileSipInfoRateTrack(d, i["info_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "invite_rate"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "invite_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["invite-rate-track"], _ = expandVoipProfileSipInviteRateTrack(d, i["invite_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "ips_rtp"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "malformed_header_no_proxy_require"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["malformed-header-no-proxy-require"], _ = expandVoipProfileSipMalformedHeaderNoProxyRequire(d, i["malformed_header_no_proxy_require"], pre_append)
	}
	pre_append = pre + ".0." + "malformed_header_no_require"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["malformed-header-no-require"], _ = expandVoipProfileSipMalformedHeaderNoRequire(d, i["malformed_header_no_require"], pre_append)
	}
	pre_append = pre + ".0." + "malformed_header_p_asserted_identity"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "message_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["message-rate-track"], _ = expandVoipProfileSipMessageRateTrack(d, i["message_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "nat_port_range"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["nat-port-range"], _ = expandVoipProfileSipNatPortRange(d, i["nat_port_range"], pre_append)
	}
	pre_append = pre + ".0." + "nat_trace"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "notify_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["notify-rate-track"], _ = expandVoipProfileSipNotifyRateTrack(d, i["notify_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "open_contact_pinhole"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "options_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["options-rate-track"], _ = expandVoipProfileSipOptionsRateTrack(d, i["options_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "prack_rate"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "prack_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["prack-rate-track"], _ = expandVoipProfileSipPrackRateTrack(d, i["prack_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "preserve_override"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "publish_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["publish-rate-track"], _ = expandVoipProfileSipPublishRateTrack(d, i["publish_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "refer_rate"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "refer_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["refer-rate-track"], _ = expandVoipProfileSipReferRateTrack(d, i["refer_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "register_contact_trace"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "register_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["register-rate-track"], _ = expandVoipProfileSipRegisterRateTrack(d, i["register_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "rfc2543_branch"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "subscribe_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["subscribe-rate-track"], _ = expandVoipProfileSipSubscribeRateTrack(d, i["subscribe_rate_track"], pre_append)
	}
	pre_append = pre + ".0." + "unknown_header"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
	...
	pre_append = pre + ".0." + "update_rate_track"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		result["update-rate-track"], _ = expandVoipProfileSipUpdateRateTrack(d, i["update_rate_track"], pre_append)
	}
...
func expandVoipProfileSipAckRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipByeRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileSipCallIdRegex(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipCancelRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipContentTypeRegex(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipInfoRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipInviteRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipMalformedHeaderNoProxyRequire(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileSipMalformedHeaderNoRequire(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipMessageRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileSipNatPortRange(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipNotifyRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipOptionsRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipPrackRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipPublishRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipReferRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipRegisterRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipSubscribeRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandVoipProfileSipUpdateRateTrack(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandVoipProfileUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectVoipProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandVoipProfileFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandVoipProfileFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandVoipProfileFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("feature_set"); ok || d.HasChange("feature_set") {
		t, err := expandVoipProfileFeatureSet(d, v, "feature_set")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["feature-set"] = t
	...
	if v, ok := d.GetOk("msrp"); ok || d.HasChange("msrp") {
		t, err := expandVoipProfileMsrp(d, v, "msrp")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["msrp"] = t
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandVoipProfileUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
