...
func flattenLogSyslogd4OverrideSettingCustomLogFormat(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenLogSyslogd4OverrideSettingSourceIpInterface(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenLogSyslogd4OverrideSettingLogTemplates(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		if _, ok := i["category"]; ok {
			v := flattenLogSyslogd4OverrideSettingLogTemplatesCategory(i["category"], d, pre_append)
			tmp["category"] = fortiAPISubPartPatch(v, "LogSyslogd4OverrideSetting-LogTemplates-Category")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "empty_value_indicator"
		if _, ok := i["empty-value-indicator"]; ok {
			v := flattenLogSyslogd4OverrideSettingLogTemplatesEmptyValueIndicator(i["empty-value-indicator"], d, pre_append)
			tmp["empty_value_indicator"] = fortiAPISubPartPatch(v, "LogSyslogd4OverrideSetting-LogTemplates-EmptyValueIndicator")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := i["id"]; ok {
			v := flattenLogSyslogd4OverrideSettingLogTemplatesId(i["id"], d, pre_append)
			tmp["id"] = fortiAPISubPartPatch(v, "LogSyslogd4OverrideSetting-LogTemplates-Id")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "template"
		if _, ok := i["template"]; ok {
			v := flattenLogSyslogd4OverrideSettingLogTemplatesTemplate(i["template"], d, pre_append)
			tmp["template"] = fortiAPISubPartPatch(v, "LogSyslogd4OverrideSetting-LogTemplates-Template")
		}
...
func flattenLogSyslogd4OverrideSettingLogTemplatesCategory(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd4OverrideSettingLogTemplatesEmptyValueIndicator(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd4OverrideSettingLogTemplatesId(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd4OverrideSettingLogTemplatesTemplate(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd4OverrideSetting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("custom_log_format", flattenLogSyslogd4OverrideSettingCustomLogFormat(o["custom-log-format"], d, "custom_log_format")); err != nil {
		if vv, ok := fortiAPIPatch(o["custom-log-format"], "LogSyslogd4OverrideSetting-CustomLogFormat"); ok {
	...
	if err = d.Set("source_ip_interface", flattenLogSyslogd4OverrideSettingSourceIpInterface(o["source-ip-interface"], d, "source_ip_interface")); err != nil {
		if vv, ok := fortiAPIPatch(o["source-ip-interface"], "LogSyslogd4OverrideSetting-SourceIpInterface"); ok {
	...
	if err = d.Set("use_management_vdom", flattenLogSyslogd4OverrideSettingUseManagementVdom(o["use-management-vdom"], d, "use_management_vdom")); err != nil {
		if vv, ok := fortiAPIPatch(o["use-management-vdom"], "LogSyslogd4OverrideSetting-UseManagementVdom"); ok {
	...
	if isImportTable() {
		if err = d.Set("log_templates", flattenLogSyslogd4OverrideSettingLogTemplates(o["log-templates"], d, "log_templates")); err != nil {
			if vv, ok := fortiAPIPatch(o["log-templates"], "LogSyslogd4OverrideSetting-LogTemplates"); ok {
...
func expandLogSyslogd4OverrideSettingCustomLogFormat(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandLogSyslogd4OverrideSettingSourceIpInterface(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandLogSyslogd4OverrideSettingLogTemplates(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "category"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["category"], _ = expandLogSyslogd4OverrideSettingLogTemplatesCategory(d, i["category"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "empty_value_indicator"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["empty-value-indicator"], _ = expandLogSyslogd4OverrideSettingLogTemplatesEmptyValueIndicator(d, i["empty_value_indicator"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["id"], _ = expandLogSyslogd4OverrideSettingLogTemplatesId(d, i["id"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "template"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["template"], _ = expandLogSyslogd4OverrideSettingLogTemplatesTemplate(d, i["template"], pre_append)
		}
...
func expandLogSyslogd4OverrideSettingLogTemplatesCategory(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd4OverrideSettingLogTemplatesEmptyValueIndicator(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd4OverrideSettingLogTemplatesId(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd4OverrideSettingLogTemplatesTemplate(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd4OverrideSetting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("custom_log_format"); ok || d.HasChange("custom_log_format") {
		t, err := expandLogSyslogd4OverrideSettingCustomLogFormat(d, v, "custom_log_format")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("source_ip_interface"); ok || d.HasChange("source_ip_interface") {
		t, err := expandLogSyslogd4OverrideSettingSourceIpInterface(d, v, "source_ip_interface")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("use_management_vdom"); ok || d.HasChange("use_management_vdom") {
		t, err := expandLogSyslogd4OverrideSettingUseManagementVdom(d, v, "use_management_vdom")
		if err != nil {
			return &obj, err
		} else if t != nil {
