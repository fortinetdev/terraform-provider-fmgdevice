...
func resourceRouterMulticast6PimSmGlobalRpAddressCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateRouterMulticast6PimSmGlobalRpAddress(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateRouterMulticast6PimSmGlobalRpAddress(obj, paradict, wsParams)
		if err != nil {
...
func resourceRouterMulticast6PimSmGlobalRpAddressUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterMulticast6PimSmGlobalRpAddress(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating RouterMulticast6PimSmGlobalRpAddress resource: %v", err)
	}
...
func resourceRouterMulticast6PimSmGlobalRpAddressDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteRouterMulticast6PimSmGlobalRpAddress(mkey, paradict, wsParams)
	if err != nil {
