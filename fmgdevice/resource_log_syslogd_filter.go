...
func resourceLogSyslogdFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogdFilter(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogSyslogdFilter(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogSyslogdFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogdFilter(d, true)
...
func flattenLogSyslogdFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogdFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogSyslogdFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogSyslogdFilter-Debug"); ok {
...
func expandLogSyslogdFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogdFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogSyslogdFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
