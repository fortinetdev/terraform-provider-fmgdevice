...
func resourceSwitchControllerSnmpCommunityHostsCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSwitchControllerSnmpCommunityHosts(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSwitchControllerSnmpCommunityHosts(obj, paradict, wsParams)
		if err != nil {
...
func resourceSwitchControllerSnmpCommunityHostsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSwitchControllerSnmpCommunityHosts(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SwitchControllerSnmpCommunityHosts resource: %v", err)
	}
...
func resourceSwitchControllerSnmpCommunityHostsDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSwitchControllerSnmpCommunityHosts(mkey, paradict, wsParams)
	if err != nil {
