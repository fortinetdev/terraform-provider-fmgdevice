...
func resourceWirelessControllerApcfgProfileCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerApcfgProfile(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerApcfgProfile(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerApcfgProfileUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerApcfgProfile(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerApcfgProfile resource: %v", err)
	}
...
func resourceWirelessControllerApcfgProfileDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerApcfgProfile(mkey, paradict, wsParams)
	if err != nil {
