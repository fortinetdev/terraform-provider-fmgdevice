...
func resourceRouterBgpNeighborConditionalAdvertiseCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateRouterBgpNeighborConditionalAdvertise(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateRouterBgpNeighborConditionalAdvertise(obj, paradict, wsParams)
		if err != nil {
...
func resourceRouterBgpNeighborConditionalAdvertiseUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterBgpNeighborConditionalAdvertise(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating RouterBgpNeighborConditionalAdvertise resource: %v", err)
	}
...
func resourceRouterBgpNeighborConditionalAdvertiseDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteRouterBgpNeighborConditionalAdvertise(mkey, paradict, wsParams)
	if err != nil {
