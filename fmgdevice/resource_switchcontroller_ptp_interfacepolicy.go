...
func resourceSwitchControllerPtpInterfacePolicyCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSwitchControllerPtpInterfacePolicy(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSwitchControllerPtpInterfacePolicy(obj, paradict, wsParams)
		if err != nil {
...
func resourceSwitchControllerPtpInterfacePolicyUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSwitchControllerPtpInterfacePolicy(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SwitchControllerPtpInterfacePolicy resource: %v", err)
	}
...
func resourceSwitchControllerPtpInterfacePolicyDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSwitchControllerPtpInterfacePolicy(mkey, paradict, wsParams)
	if err != nil {
