...
func resourceDnsfilterDomainFilterEntriesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceDnsfilterDomainFilterEntriesSortCreateUpdate,
		Read:   resourceDnsfilterDomainFilterEntriesSortRead,
		Update: resourceDnsfilterDomainFilterEntriesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceDnsfilterDomainFilterEntriesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateDnsfilterDomainFilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting DnsfilterDomainFilterEntries: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceDnsfilterDomainFilterEntriesSortRead(d, m)
}

func resourceDnsfilterDomainFilterEntriesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadDnsfilterDomainFilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading DnsfilterDomainFilterEntries sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading DnsfilterDomainFilterEntries List for (%s): %s", d.Id(), err)
		}
	} else {
