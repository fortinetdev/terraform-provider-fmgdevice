...
func resourceLogFortiguardOverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortiguardOverrideFilter(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogFortiguardOverrideFilter(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogFortiguardOverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortiguardOverrideFilter(d, true)
...
func flattenLogFortiguardOverrideFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogFortiguardOverrideFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortiguardOverrideFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogFortiguardOverrideFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogFortiguardOverrideFilter-Debug"); ok {
	...
	if err = d.Set("http_transaction", flattenLogFortiguardOverrideFilterHttpTransaction(o["http-transaction"], d, "http_transaction")); err != nil {
		if vv, ok := fortiAPIPatch(o["http-transaction"], "LogFortiguardOverrideFilter-HttpTransaction"); ok {
...
func expandLogFortiguardOverrideFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortiguardOverrideFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortiguardOverrideFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogFortiguardOverrideFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
	...
	if v, ok := d.GetOk("http_transaction"); ok || d.HasChange("http_transaction") {
		t, err := expandLogFortiguardOverrideFilterHttpTransaction(d, v, "http_transaction")
		if err != nil {
			return &obj, err
		} else if t != nil {
