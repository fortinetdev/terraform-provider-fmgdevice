...
func resourceSystemAffinityPacketRedistributionCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSystemAffinityPacketRedistribution(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSystemAffinityPacketRedistribution(obj, paradict, wsParams)
		if err != nil {
...
func resourceSystemAffinityPacketRedistributionUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAffinityPacketRedistribution(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SystemAffinityPacketRedistribution resource: %v", err)
	}
...
func resourceSystemAffinityPacketRedistributionDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSystemAffinityPacketRedistribution(mkey, paradict, wsParams)
	if err != nil {
