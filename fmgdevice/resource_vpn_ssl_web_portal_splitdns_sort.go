...
func resourceVpnSslWebPortalSplitDnsSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVpnSslWebPortalSplitDnsSortCreateUpdate,
		Read:   resourceVpnSslWebPortalSplitDnsSortRead,
		Update: resourceVpnSslWebPortalSplitDnsSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVpnSslWebPortalSplitDnsSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVpnSslWebPortalSplitDnsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VpnSslWebPortalSplitDns: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVpnSslWebPortalSplitDnsSortRead(d, m)
}

func resourceVpnSslWebPortalSplitDnsSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVpnSslWebPortalSplitDnsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VpnSslWebPortalSplitDns sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VpnSslWebPortalSplitDns List for (%s): %s", d.Id(), err)
		}
	} else {
