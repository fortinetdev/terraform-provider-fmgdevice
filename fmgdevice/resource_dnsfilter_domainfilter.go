...
func resourceDnsfilterDomainFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	v, err := c.UpdateDnsfilterDomainFilter(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating DnsfilterDomainFilter resource: %v", err)
	}
...
func flattenDnsfilterDomainFilterFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenDnsfilterDomainFilterFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenDnsfilterDomainFilterFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenDnsfilterDomainFilterUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectDnsfilterDomainFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenDnsfilterDomainFilterFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "DnsfilterDomainFilter-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenDnsfilterDomainFilterFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "DnsfilterDomainFilter-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenDnsfilterDomainFilterFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "DnsfilterDomainFilter-FabricObjectSource"); ok {
	...
	if err = d.Set("uuid", flattenDnsfilterDomainFilterUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "DnsfilterDomainFilter-Uuid"); ok {
...
func expandDnsfilterDomainFilterFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandDnsfilterDomainFilterFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandDnsfilterDomainFilterFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandDnsfilterDomainFilterUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectDnsfilterDomainFilter(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandDnsfilterDomainFilterFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandDnsfilterDomainFilterFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandDnsfilterDomainFilterFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandDnsfilterDomainFilterUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
