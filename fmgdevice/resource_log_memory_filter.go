...
func resourceLogMemoryFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogMemoryFilter(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogMemoryFilter(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogMemoryFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogMemoryFilter(d, true)
...
func resourceLogMemoryFilterRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogMemoryFilter(mkey, paradict)
	if err != nil {
		d.SetId("")
...
func flattenLogMemoryFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogMemoryFilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogMemoryFilterFreeStyle(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		if _, ok := i["category"]; ok {
			v := flattenLogMemoryFilterFreeStyleCategory(i["category"], d, pre_append)
			tmp["category"] = fortiAPISubPartPatch(v, "LogMemoryFilter-FreeStyle-Category")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter"
		if _, ok := i["filter"]; ok {
			v := flattenLogMemoryFilterFreeStyleFilter(i["filter"], d, pre_append)
			tmp["filter"] = fortiAPISubPartPatch(v, "LogMemoryFilter-FreeStyle-Filter")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter_type"
		if _, ok := i["filter-type"]; ok {
			v := flattenLogMemoryFilterFreeStyleFilterType(i["filter-type"], d, pre_append)
			tmp["filter_type"] = fortiAPISubPartPatch(v, "LogMemoryFilter-FreeStyle-FilterType")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := i["id"]; ok {
			v := flattenLogMemoryFilterFreeStyleId(i["id"], d, pre_append)
			tmp["id"] = fortiAPISubPartPatch(v, "LogMemoryFilter-FreeStyle-Id")
		}
...
func flattenLogMemoryFilterFreeStyleCategory(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogMemoryFilterFreeStyleFilter(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogMemoryFilterFreeStyleFilterType(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogMemoryFilterFreeStyleId(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogMemoryFilterZtnaTraffic(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogMemoryFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("anomaly", flattenLogMemoryFilterAnomaly(o["anomaly"], d, "anomaly")); err != nil {
		if vv, ok := fortiAPIPatch(o["anomaly"], "LogMemoryFilter-Anomaly"); ok {
	...
	if err = d.Set("debug", flattenLogMemoryFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogMemoryFilter-Debug"); ok {
	...
	if err = d.Set("filter", flattenLogMemoryFilterFilter(o["filter"], d, "filter")); err != nil {
		if vv, ok := fortiAPIPatch(o["filter"], "LogMemoryFilter-Filter"); ok {
	...
	if err = d.Set("filter_type", flattenLogMemoryFilterFilterType(o["filter-type"], d, "filter_type")); err != nil {
		if vv, ok := fortiAPIPatch(o["filter-type"], "LogMemoryFilter-FilterType"); ok {
	...
	if err = d.Set("forti_switch", flattenLogMemoryFilterFortiSwitch(o["forti-switch"], d, "forti_switch")); err != nil {
		if vv, ok := fortiAPIPatch(o["forti-switch"], "LogMemoryFilter-FortiSwitch"); ok {
	...
	if err = d.Set("forward_traffic", flattenLogMemoryFilterForwardTraffic(o["forward-traffic"], d, "forward_traffic")); err != nil {
		if vv, ok := fortiAPIPatch(o["forward-traffic"], "LogMemoryFilter-ForwardTraffic"); ok {
	...
	if isImportTable() {
		if err = d.Set("free_style", flattenLogMemoryFilterFreeStyle(o["free-style"], d, "free_style")); err != nil {
			if vv, ok := fortiAPIPatch(o["free-style"], "LogMemoryFilter-FreeStyle"); ok {
	...
	if err = d.Set("gtp", flattenLogMemoryFilterGtp(o["gtp"], d, "gtp")); err != nil {
		if vv, ok := fortiAPIPatch(o["gtp"], "LogMemoryFilter-Gtp"); ok {
	...
	if err = d.Set("local_traffic", flattenLogMemoryFilterLocalTraffic(o["local-traffic"], d, "local_traffic")); err != nil {
		if vv, ok := fortiAPIPatch(o["local-traffic"], "LogMemoryFilter-LocalTraffic"); ok {
	...
	if err = d.Set("multicast_traffic", flattenLogMemoryFilterMulticastTraffic(o["multicast-traffic"], d, "multicast_traffic")); err != nil {
		if vv, ok := fortiAPIPatch(o["multicast-traffic"], "LogMemoryFilter-MulticastTraffic"); ok {
	...
	if err = d.Set("severity", flattenLogMemoryFilterSeverity(o["severity"], d, "severity")); err != nil {
		if vv, ok := fortiAPIPatch(o["severity"], "LogMemoryFilter-Severity"); ok {
	...
	if err = d.Set("sniffer_traffic", flattenLogMemoryFilterSnifferTraffic(o["sniffer-traffic"], d, "sniffer_traffic")); err != nil {
		if vv, ok := fortiAPIPatch(o["sniffer-traffic"], "LogMemoryFilter-SnifferTraffic"); ok {
	...
	if err = d.Set("voip", flattenLogMemoryFilterVoip(o["voip"], d, "voip")); err != nil {
		if vv, ok := fortiAPIPatch(o["voip"], "LogMemoryFilter-Voip"); ok {
	...
	if err = d.Set("ztna_traffic", flattenLogMemoryFilterZtnaTraffic(o["ztna-traffic"], d, "ztna_traffic")); err != nil {
		if vv, ok := fortiAPIPatch(o["ztna-traffic"], "LogMemoryFilter-ZtnaTraffic"); ok {
...
func expandLogMemoryFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogMemoryFilterFortiSwitch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogMemoryFilterFreeStyle(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["category"], _ = expandLogMemoryFilterFreeStyleCategory(d, i["category"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["filter"], _ = expandLogMemoryFilterFreeStyleFilter(d, i["filter"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter_type"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["filter-type"], _ = expandLogMemoryFilterFreeStyleFilterType(d, i["filter_type"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["id"], _ = expandLogMemoryFilterFreeStyleId(d, i["id"], pre_append)
		}
...
func expandLogMemoryFilterFreeStyleCategory(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogMemoryFilterFreeStyleFilter(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogMemoryFilterFreeStyleFilterType(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogMemoryFilterFreeStyleId(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogMemoryFilterZtnaTraffic(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func getObjectLogMemoryFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogMemoryFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
	...
	if v, ok := d.GetOk("forti_switch"); ok || d.HasChange("forti_switch") {
		t, err := expandLogMemoryFilterFortiSwitch(d, v, "forti_switch")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["forti-switch"] = t
	...
	if bemptysontable {
		...
		if v, ok := d.GetOk("free_style"); ok || d.HasChange("free_style") {
			t, err := expandLogMemoryFilterFreeStyle(d, v, "free_style")
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["free-style"] = t
	...
	if v, ok := d.GetOk("ztna_traffic"); ok || d.HasChange("ztna_traffic") {
		t, err := expandLogMemoryFilterZtnaTraffic(d, v, "ztna_traffic")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ztna-traffic"] = t
