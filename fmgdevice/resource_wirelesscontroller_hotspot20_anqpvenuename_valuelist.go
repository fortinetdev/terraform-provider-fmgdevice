...
func resourceWirelessControllerHotspot20AnqpVenueNameValueListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerHotspot20AnqpVenueNameValueList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerHotspot20AnqpVenueNameValueList(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerHotspot20AnqpVenueNameValueListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerHotspot20AnqpVenueNameValueList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerHotspot20AnqpVenueNameValueList resource: %v", err)
	}
...
func resourceWirelessControllerHotspot20AnqpVenueNameValueListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerHotspot20AnqpVenueNameValueList(mkey, paradict, wsParams)
	if err != nil {
