...
func resourceSwitchControllerDynamicPortPolicyPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourceSwitchControllerDynamicPortPolicyPolicySortCreateUpdate,
		Read:   resourceSwitchControllerDynamicPortPolicyPolicySortRead,
		Update: resourceSwitchControllerDynamicPortPolicyPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourceSwitchControllerDynamicPortPolicyPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateSwitchControllerDynamicPortPolicyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting SwitchControllerDynamicPortPolicyPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceSwitchControllerDynamicPortPolicyPolicySortRead(d, m)
}

func resourceSwitchControllerDynamicPortPolicyPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadSwitchControllerDynamicPortPolicyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading SwitchControllerDynamicPortPolicyPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading SwitchControllerDynamicPortPolicyPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
