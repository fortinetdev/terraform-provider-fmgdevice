...
func resourceReportLayoutPageFooterFooterItemSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceReportLayoutPageFooterFooterItemSortCreateUpdate,
		Read:   resourceReportLayoutPageFooterFooterItemSortRead,
		Update: resourceReportLayoutPageFooterFooterItemSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceReportLayoutPageFooterFooterItemSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateReportLayoutPageFooterFooterItemSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ReportLayoutPageFooterFooterItem: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceReportLayoutPageFooterFooterItemSortRead(d, m)
}

func resourceReportLayoutPageFooterFooterItemSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadReportLayoutPageFooterFooterItemSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ReportLayoutPageFooterFooterItem sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ReportLayoutPageFooterFooterItem List for (%s): %s", d.Id(), err)
		}
	} else {
