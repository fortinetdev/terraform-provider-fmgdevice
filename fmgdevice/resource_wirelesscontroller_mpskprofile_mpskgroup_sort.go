...
func resourceWirelessControllerMpskProfileMpskGroupSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWirelessControllerMpskProfileMpskGroupSortCreateUpdate,
		Read:   resourceWirelessControllerMpskProfileMpskGroupSortRead,
		Update: resourceWirelessControllerMpskProfileMpskGroupSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWirelessControllerMpskProfileMpskGroupSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWirelessControllerMpskProfileMpskGroupSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WirelessControllerMpskProfileMpskGroup: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWirelessControllerMpskProfileMpskGroupSortRead(d, m)
}

func resourceWirelessControllerMpskProfileMpskGroupSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWirelessControllerMpskProfileMpskGroupSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WirelessControllerMpskProfileMpskGroup sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WirelessControllerMpskProfileMpskGroup List for (%s): %s", d.Id(), err)
		}
	} else {
