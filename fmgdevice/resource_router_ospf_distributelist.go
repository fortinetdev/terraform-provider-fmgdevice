...
func resourceRouterOspfDistributeListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateRouterOspfDistributeList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateRouterOspfDistributeList(obj, paradict, wsParams)
		if err != nil {
...
func resourceRouterOspfDistributeListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterOspfDistributeList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating RouterOspfDistributeList resource: %v", err)
	}
...
func resourceRouterOspfDistributeListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteRouterOspfDistributeList(mkey, paradict, wsParams)
	if err != nil {
