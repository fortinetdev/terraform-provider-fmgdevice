...
func resourceWebProxyUrlListEntriesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWebProxyUrlListEntriesSortCreateUpdate,
		Read:   resourceWebProxyUrlListEntriesSortRead,
		Update: resourceWebProxyUrlListEntriesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWebProxyUrlListEntriesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWebProxyUrlListEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WebProxyUrlListEntries: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWebProxyUrlListEntriesSortRead(d, m)
}

func resourceWebProxyUrlListEntriesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWebProxyUrlListEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WebProxyUrlListEntries sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WebProxyUrlListEntries List for (%s): %s", d.Id(), err)
		}
	} else {
