...
func flattenFirewallScheduleOnetimeFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenFirewallScheduleOnetimeFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectFirewallScheduleOnetime(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenFirewallScheduleOnetimeFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "FirewallScheduleOnetime-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object_source", flattenFirewallScheduleOnetimeFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "FirewallScheduleOnetime-FabricObjectSource"); ok {
...
func expandFirewallScheduleOnetimeFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallScheduleOnetimeFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallScheduleOnetime(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandFirewallScheduleOnetimeFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandFirewallScheduleOnetimeFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
