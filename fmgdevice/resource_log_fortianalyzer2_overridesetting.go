...
func flattenLogFortianalyzer2OverrideSettingVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortianalyzer2OverrideSetting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("vrf_select", flattenLogFortianalyzer2OverrideSettingVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "LogFortianalyzer2OverrideSetting-VrfSelect"); ok {
...
func expandLogFortianalyzer2OverrideSettingVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer2OverrideSetting(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandLogFortianalyzer2OverrideSettingVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
