...
func flattenWebProxyForwardServerFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWebProxyForwardServerFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWebProxyForwardServerFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWebProxyForwardServerUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWebProxyForwardServerIppool6(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func refreshObjectWebProxyForwardServer(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenWebProxyForwardServerFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "WebProxyForwardServer-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenWebProxyForwardServerFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "WebProxyForwardServer-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenWebProxyForwardServerFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "WebProxyForwardServer-FabricObjectSource"); ok {
	...
	if err = d.Set("uuid", flattenWebProxyForwardServerUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "WebProxyForwardServer-Uuid"); ok {
	...
	if err = d.Set("ippool6", flattenWebProxyForwardServerIppool6(o["ippool6"], d, "ippool6")); err != nil {
		if vv, ok := fortiAPIPatch(o["ippool6"], "WebProxyForwardServer-Ippool6"); ok {
...
func expandWebProxyForwardServerFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWebProxyForwardServerFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWebProxyForwardServerFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWebProxyForwardServerUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWebProxyForwardServerIppool6(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func getObjectWebProxyForwardServer(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandWebProxyForwardServerFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandWebProxyForwardServerFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandWebProxyForwardServerFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandWebProxyForwardServerUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
	...
	if v, ok := d.GetOk("ippool6"); ok || d.HasChange("ippool6") {
		t, err := expandWebProxyForwardServerIppool6(d, v, "ippool6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ippool6"] = t
