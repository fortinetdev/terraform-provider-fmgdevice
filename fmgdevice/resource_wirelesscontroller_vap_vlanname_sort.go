...
func resourceWirelessControllerVapVlanNameSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWirelessControllerVapVlanNameSortCreateUpdate,
		Read:   resourceWirelessControllerVapVlanNameSortRead,
		Update: resourceWirelessControllerVapVlanNameSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWirelessControllerVapVlanNameSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWirelessControllerVapVlanNameSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WirelessControllerVapVlanName: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWirelessControllerVapVlanNameSortRead(d, m)
}

func resourceWirelessControllerVapVlanNameSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWirelessControllerVapVlanNameSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WirelessControllerVapVlanName sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WirelessControllerVapVlanName List for (%s): %s", d.Id(), err)
		}
	} else {
