...
func resourceVpnKmipServerServerListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVpnKmipServerServerListSortCreateUpdate,
		Read:   resourceVpnKmipServerServerListSortRead,
		Update: resourceVpnKmipServerServerListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVpnKmipServerServerListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVpnKmipServerServerListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VpnKmipServerServerList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVpnKmipServerServerListSortRead(d, m)
}

func resourceVpnKmipServerServerListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVpnKmipServerServerListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VpnKmipServerServerList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VpnKmipServerServerList List for (%s): %s", d.Id(), err)
		}
	} else {
