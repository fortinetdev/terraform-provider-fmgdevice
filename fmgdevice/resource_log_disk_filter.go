...
func resourceLogDiskFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogDiskFilter(d, false)
	if err != nil {
...
func resourceLogDiskFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogDiskFilter(d, true)
...
func flattenLogDiskFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogDiskFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogDiskFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogDiskFilter-Debug"); ok {
...
func expandLogDiskFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogDiskFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogDiskFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
