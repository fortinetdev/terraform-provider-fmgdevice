...
func resourceLogFortianalyzer2OverrideFilterFreeStyleCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateLogFortianalyzer2OverrideFilterFreeStyle(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateLogFortianalyzer2OverrideFilterFreeStyle(obj, paradict, wsParams)
		if err != nil {
...
func resourceLogFortianalyzer2OverrideFilterFreeStyleUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogFortianalyzer2OverrideFilterFreeStyle(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating LogFortianalyzer2OverrideFilterFreeStyle resource: %v", err)
	}
...
func resourceLogFortianalyzer2OverrideFilterFreeStyleDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteLogFortianalyzer2OverrideFilterFreeStyle(mkey, paradict, wsParams)
	if err != nil {
