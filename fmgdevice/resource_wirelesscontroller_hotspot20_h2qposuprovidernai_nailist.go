...
func resourceWirelessControllerHotspot20H2QpOsuProviderNaiNaiListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerHotspot20H2QpOsuProviderNaiNaiList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerHotspot20H2QpOsuProviderNaiNaiList(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerHotspot20H2QpOsuProviderNaiNaiListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerHotspot20H2QpOsuProviderNaiNaiList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerHotspot20H2QpOsuProviderNaiNaiList resource: %v", err)
	}
...
func resourceWirelessControllerHotspot20H2QpOsuProviderNaiNaiListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerHotspot20H2QpOsuProviderNaiNaiList(mkey, paradict, wsParams)
	if err != nil {
