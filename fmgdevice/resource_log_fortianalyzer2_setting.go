...
func resourceLogFortianalyzer2SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2Setting(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogFortianalyzer2Setting(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogFortianalyzer2SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2Setting(d, true)
...
func flattenLogFortianalyzer2SettingVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortianalyzer2Setting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("vrf_select", flattenLogFortianalyzer2SettingVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "LogFortianalyzer2Setting-VrfSelect"); ok {
...
func expandLogFortianalyzer2SettingVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func getObjectLogFortianalyzer2Setting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandLogFortianalyzer2SettingVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
