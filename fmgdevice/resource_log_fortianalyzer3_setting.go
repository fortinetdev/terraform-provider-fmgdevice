...
func resourceLogFortianalyzer3SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer3Setting(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogFortianalyzer3Setting(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogFortianalyzer3SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer3Setting(d, true)
...
func flattenLogFortianalyzer3SettingVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortianalyzer3Setting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("vrf_select", flattenLogFortianalyzer3SettingVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "LogFortianalyzer3Setting-VrfSelect"); ok {
...
func expandLogFortianalyzer3SettingVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func getObjectLogFortianalyzer3Setting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandLogFortianalyzer3SettingVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
