...
func resourceZtnaWebPortalBookmarkBookmarksSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceZtnaWebPortalBookmarkBookmarksSortCreateUpdate,
		Read:   resourceZtnaWebPortalBookmarkBookmarksSortRead,
		Update: resourceZtnaWebPortalBookmarkBookmarksSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceZtnaWebPortalBookmarkBookmarksSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateZtnaWebPortalBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ZtnaWebPortalBookmarkBookmarks: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceZtnaWebPortalBookmarkBookmarksSortRead(d, m)
}

func resourceZtnaWebPortalBookmarkBookmarksSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadZtnaWebPortalBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ZtnaWebPortalBookmarkBookmarks sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ZtnaWebPortalBookmarkBookmarks List for (%s): %s", d.Id(), err)
		}
	} else {
