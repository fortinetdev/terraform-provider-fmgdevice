...
func resourceLogSyslogd4OverrideFilterFreeStyleCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateLogSyslogd4OverrideFilterFreeStyle(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateLogSyslogd4OverrideFilterFreeStyle(obj, paradict, wsParams)
		if err != nil {
...
func resourceLogSyslogd4OverrideFilterFreeStyleUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogSyslogd4OverrideFilterFreeStyle(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating LogSyslogd4OverrideFilterFreeStyle resource: %v", err)
	}
...
func resourceLogSyslogd4OverrideFilterFreeStyleDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteLogSyslogd4OverrideFilterFreeStyle(mkey, paradict, wsParams)
	if err != nil {
