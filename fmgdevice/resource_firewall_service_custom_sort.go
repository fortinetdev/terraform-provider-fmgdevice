...
func resourceFirewallServiceCustomSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirewallServiceCustomSortCreateUpdate,
		Read:   resourceFirewallServiceCustomSortRead,
		Update: resourceFirewallServiceCustomSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceFirewallServiceCustomSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateFirewallServiceCustomSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting FirewallServiceCustom: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceFirewallServiceCustomSortRead(d, m)
}

func resourceFirewallServiceCustomSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadFirewallServiceCustomSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading FirewallServiceCustom sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading FirewallServiceCustom List for (%s): %s", d.Id(), err)
		}
	} else {
