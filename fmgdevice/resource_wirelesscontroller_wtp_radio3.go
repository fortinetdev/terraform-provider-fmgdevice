...
func resourceWirelessControllerWtpRadio3Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWirelessControllerWtpRadio3(d, false)
	if err != nil {
	...
	_, err = c.UpdateWirelessControllerWtpRadio3(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceWirelessControllerWtpRadio3Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWirelessControllerWtpRadio3(d, true)
	...
	_, err = c.UpdateWirelessControllerWtpRadio3(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing WirelessControllerWtpRadio3 resource: %v", err)
	}
...
func flattenWirelessControllerWtpRadio3CcaThreshold2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio3OverrideCcaThreshold2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio3OverrideVapStatus2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio3VapStatus2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio3Vap102edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap112edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap122edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap132edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap142edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap152edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio3Vap162edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio3Vap92edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectWirelessControllerWtpRadio3(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("cca_threshold", flattenWirelessControllerWtpRadio3CcaThreshold2edl(o["cca-threshold"], d, "cca_threshold")); err != nil {
		if vv, ok := fortiAPIPatch(o["cca-threshold"], "WirelessControllerWtpRadio3-CcaThreshold"); ok {
	...
	if err = d.Set("override_cca_threshold", flattenWirelessControllerWtpRadio3OverrideCcaThreshold2edl(o["override-cca-threshold"], d, "override_cca_threshold")); err != nil {
		if vv, ok := fortiAPIPatch(o["override-cca-threshold"], "WirelessControllerWtpRadio3-OverrideCcaThreshold"); ok {
	...
	if err = d.Set("override_vap_status", flattenWirelessControllerWtpRadio3OverrideVapStatus2edl(o["override-vap-status"], d, "override_vap_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["override-vap-status"], "WirelessControllerWtpRadio3-OverrideVapStatus"); ok {
	...
	if err = d.Set("vap_status", flattenWirelessControllerWtpRadio3VapStatus2edl(o["vap-status"], d, "vap_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap-status"], "WirelessControllerWtpRadio3-VapStatus"); ok {
	...
	if err = d.Set("vap10", flattenWirelessControllerWtpRadio3Vap102edl(o["vap10"], d, "vap10")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap10"], "WirelessControllerWtpRadio3-Vap10"); ok {
	...
	if err = d.Set("vap11", flattenWirelessControllerWtpRadio3Vap112edl(o["vap11"], d, "vap11")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap11"], "WirelessControllerWtpRadio3-Vap11"); ok {
	...
	if err = d.Set("vap12", flattenWirelessControllerWtpRadio3Vap122edl(o["vap12"], d, "vap12")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap12"], "WirelessControllerWtpRadio3-Vap12"); ok {
	...
	if err = d.Set("vap13", flattenWirelessControllerWtpRadio3Vap132edl(o["vap13"], d, "vap13")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap13"], "WirelessControllerWtpRadio3-Vap13"); ok {
	...
	if err = d.Set("vap14", flattenWirelessControllerWtpRadio3Vap142edl(o["vap14"], d, "vap14")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap14"], "WirelessControllerWtpRadio3-Vap14"); ok {
	...
	if err = d.Set("vap15", flattenWirelessControllerWtpRadio3Vap152edl(o["vap15"], d, "vap15")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap15"], "WirelessControllerWtpRadio3-Vap15"); ok {
	...
	if err = d.Set("vap16", flattenWirelessControllerWtpRadio3Vap162edl(o["vap16"], d, "vap16")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap16"], "WirelessControllerWtpRadio3-Vap16"); ok {
	...
	if err = d.Set("vap9", flattenWirelessControllerWtpRadio3Vap92edl(o["vap9"], d, "vap9")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap9"], "WirelessControllerWtpRadio3-Vap9"); ok {
...
func expandWirelessControllerWtpRadio3CcaThreshold2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio3OverrideCcaThreshold2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio3OverrideVapStatus2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio3VapStatus2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio3Vap102edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap112edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap122edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap132edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap142edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap152edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio3Vap162edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio3Vap92edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectWirelessControllerWtpRadio3(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("cca_threshold"); ok || d.HasChange("cca_threshold") {
		t, err := expandWirelessControllerWtpRadio3CcaThreshold2edl(d, v, "cca_threshold")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["cca-threshold"] = t
	...
	if v, ok := d.GetOk("override_cca_threshold"); ok || d.HasChange("override_cca_threshold") {
		t, err := expandWirelessControllerWtpRadio3OverrideCcaThreshold2edl(d, v, "override_cca_threshold")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("override_vap_status"); ok || d.HasChange("override_vap_status") {
		t, err := expandWirelessControllerWtpRadio3OverrideVapStatus2edl(d, v, "override_vap_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("vap_status"); ok || d.HasChange("vap_status") {
		t, err := expandWirelessControllerWtpRadio3VapStatus2edl(d, v, "vap_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap-status"] = t
	...
	if v, ok := d.GetOk("vap10"); ok || d.HasChange("vap10") {
		t, err := expandWirelessControllerWtpRadio3Vap102edl(d, v, "vap10")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap10"] = t
	...
	if v, ok := d.GetOk("vap11"); ok || d.HasChange("vap11") {
		t, err := expandWirelessControllerWtpRadio3Vap112edl(d, v, "vap11")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap11"] = t
	...
	if v, ok := d.GetOk("vap12"); ok || d.HasChange("vap12") {
		t, err := expandWirelessControllerWtpRadio3Vap122edl(d, v, "vap12")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap12"] = t
	...
	if v, ok := d.GetOk("vap13"); ok || d.HasChange("vap13") {
		t, err := expandWirelessControllerWtpRadio3Vap132edl(d, v, "vap13")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap13"] = t
	...
	if v, ok := d.GetOk("vap14"); ok || d.HasChange("vap14") {
		t, err := expandWirelessControllerWtpRadio3Vap142edl(d, v, "vap14")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap14"] = t
	...
	if v, ok := d.GetOk("vap15"); ok || d.HasChange("vap15") {
		t, err := expandWirelessControllerWtpRadio3Vap152edl(d, v, "vap15")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap15"] = t
	...
	if v, ok := d.GetOk("vap16"); ok || d.HasChange("vap16") {
		t, err := expandWirelessControllerWtpRadio3Vap162edl(d, v, "vap16")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap16"] = t
	...
	if v, ok := d.GetOk("vap9"); ok || d.HasChange("vap9") {
		t, err := expandWirelessControllerWtpRadio3Vap92edl(d, v, "vap9")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap9"] = t
