...
func resourceWirelessControllerAccessControlListLayer3Ipv4RulesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate,
		Read:   resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortRead,
		Update: resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWirelessControllerAccessControlListLayer3Ipv4RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WirelessControllerAccessControlListLayer3Ipv4Rules: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortRead(d, m)
}

func resourceWirelessControllerAccessControlListLayer3Ipv4RulesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWirelessControllerAccessControlListLayer3Ipv4RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WirelessControllerAccessControlListLayer3Ipv4Rules sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WirelessControllerAccessControlListLayer3Ipv4Rules List for (%s): %s", d.Id(), err)
		}
	} else {
