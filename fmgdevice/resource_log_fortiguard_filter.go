...
func resourceLogFortiguardFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortiguardFilter(d, false)
	if err != nil {
...
func resourceLogFortiguardFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortiguardFilter(d, true)
	...
	_, err = c.UpdateLogFortiguardFilter(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing LogFortiguardFilter resource: %v", err)
	}
...
func flattenLogFortiguardFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortiguardFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("http_transaction", flattenLogFortiguardFilterHttpTransaction(o["http-transaction"], d, "http_transaction")); err != nil {
		if vv, ok := fortiAPIPatch(o["http-transaction"], "LogFortiguardFilter-HttpTransaction"); ok {
...
func expandLogFortiguardFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortiguardFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok || d.HasChange("http_transaction") {
		t, err := expandLogFortiguardFilterHttpTransaction(d, v, "http_transaction")
		if err != nil {
			return &obj, err
		} else if t != nil {
