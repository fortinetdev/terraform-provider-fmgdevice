...
func resourceWebfilterUrlfilterEntriesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWebfilterUrlfilterEntriesSortCreateUpdate,
		Read:   resourceWebfilterUrlfilterEntriesSortRead,
		Update: resourceWebfilterUrlfilterEntriesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWebfilterUrlfilterEntriesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWebfilterUrlfilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WebfilterUrlfilterEntries: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWebfilterUrlfilterEntriesSortRead(d, m)
}

func resourceWebfilterUrlfilterEntriesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWebfilterUrlfilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WebfilterUrlfilterEntries sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WebfilterUrlfilterEntries List for (%s): %s", d.Id(), err)
		}
	} else {
