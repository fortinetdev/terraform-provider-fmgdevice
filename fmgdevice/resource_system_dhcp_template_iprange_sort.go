...
func resourceSystemDhcpTemplateIpRangeSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceSystemDhcpTemplateIpRangeSortCreateUpdate,
		Read:   resourceSystemDhcpTemplateIpRangeSortRead,
		Update: resourceSystemDhcpTemplateIpRangeSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceSystemDhcpTemplateIpRangeSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateSystemDhcpTemplateIpRangeSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting SystemDhcpTemplateIpRange: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceSystemDhcpTemplateIpRangeSortRead(d, m)
}

func resourceSystemDhcpTemplateIpRangeSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadSystemDhcpTemplateIpRangeSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading SystemDhcpTemplateIpRange sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading SystemDhcpTemplateIpRange List for (%s): %s", d.Id(), err)
		}
	} else {
