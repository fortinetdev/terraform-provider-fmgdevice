...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerHotspot20H2QpTermsAndConditions(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerHotspot20H2QpTermsAndConditions(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerHotspot20H2QpTermsAndConditions(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerHotspot20H2QpTermsAndConditions resource: %v", err)
	}
...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerHotspot20H2QpTermsAndConditions(mkey, paradict, wsParams)
	if err != nil {
