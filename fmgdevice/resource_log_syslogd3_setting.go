...
func resourceLogSyslogd3SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd3Setting(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogSyslogd3Setting(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogSyslogd3SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd3Setting(d, true)
...
func flattenLogSyslogd3SettingCustomLogFormat(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenLogSyslogd3SettingVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd3SettingLogTemplates(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		if _, ok := i["category"]; ok {
			v := flattenLogSyslogd3SettingLogTemplatesCategory(i["category"], d, pre_append)
			tmp["category"] = fortiAPISubPartPatch(v, "LogSyslogd3Setting-LogTemplates-Category")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "empty_value_indicator"
		if _, ok := i["empty-value-indicator"]; ok {
			v := flattenLogSyslogd3SettingLogTemplatesEmptyValueIndicator(i["empty-value-indicator"], d, pre_append)
			tmp["empty_value_indicator"] = fortiAPISubPartPatch(v, "LogSyslogd3Setting-LogTemplates-EmptyValueIndicator")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := i["id"]; ok {
			v := flattenLogSyslogd3SettingLogTemplatesId(i["id"], d, pre_append)
			tmp["id"] = fortiAPISubPartPatch(v, "LogSyslogd3Setting-LogTemplates-Id")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "template"
		if _, ok := i["template"]; ok {
			v := flattenLogSyslogd3SettingLogTemplatesTemplate(i["template"], d, pre_append)
			tmp["template"] = fortiAPISubPartPatch(v, "LogSyslogd3Setting-LogTemplates-Template")
		}
...
func flattenLogSyslogd3SettingLogTemplatesCategory(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd3SettingLogTemplatesEmptyValueIndicator(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd3SettingLogTemplatesId(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogSyslogd3SettingLogTemplatesTemplate(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd3Setting(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("custom_log_format", flattenLogSyslogd3SettingCustomLogFormat(o["custom-log-format"], d, "custom_log_format")); err != nil {
		if vv, ok := fortiAPIPatch(o["custom-log-format"], "LogSyslogd3Setting-CustomLogFormat"); ok {
	...
	if err = d.Set("vrf_select", flattenLogSyslogd3SettingVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "LogSyslogd3Setting-VrfSelect"); ok {
	...
	if isImportTable() {
		if err = d.Set("log_templates", flattenLogSyslogd3SettingLogTemplates(o["log-templates"], d, "log_templates")); err != nil {
			if vv, ok := fortiAPIPatch(o["log-templates"], "LogSyslogd3Setting-LogTemplates"); ok {
...
func expandLogSyslogd3SettingCustomLogFormat(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandLogSyslogd3SettingVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd3SettingLogTemplates(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "category"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["category"], _ = expandLogSyslogd3SettingLogTemplatesCategory(d, i["category"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "empty_value_indicator"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["empty-value-indicator"], _ = expandLogSyslogd3SettingLogTemplatesEmptyValueIndicator(d, i["empty_value_indicator"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["id"], _ = expandLogSyslogd3SettingLogTemplatesId(d, i["id"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "template"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["template"], _ = expandLogSyslogd3SettingLogTemplatesTemplate(d, i["template"], pre_append)
		}
...
func expandLogSyslogd3SettingLogTemplatesCategory(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd3SettingLogTemplatesEmptyValueIndicator(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd3SettingLogTemplatesId(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd3SettingLogTemplatesTemplate(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func getObjectLogSyslogd3Setting(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("custom_log_format"); ok || d.HasChange("custom_log_format") {
		t, err := expandLogSyslogd3SettingCustomLogFormat(d, v, "custom_log_format")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandLogSyslogd3SettingVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
	...
	if bemptysontable {
		...
		if v, ok := d.GetOk("log_templates"); ok || d.HasChange("log_templates") {
			t, err := expandLogSyslogd3SettingLogTemplates(d, v, "log_templates")
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["log-templates"] = t
