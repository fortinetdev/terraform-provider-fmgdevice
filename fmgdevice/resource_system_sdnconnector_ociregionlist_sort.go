...
func resourceSystemSdnConnectorOciRegionListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceSystemSdnConnectorOciRegionListSortCreateUpdate,
		Read:   resourceSystemSdnConnectorOciRegionListSortRead,
		Update: resourceSystemSdnConnectorOciRegionListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceSystemSdnConnectorOciRegionListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateSystemSdnConnectorOciRegionListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting SystemSdnConnectorOciRegionList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceSystemSdnConnectorOciRegionListSortRead(d, m)
}

func resourceSystemSdnConnectorOciRegionListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadSystemSdnConnectorOciRegionListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading SystemSdnConnectorOciRegionList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading SystemSdnConnectorOciRegionList List for (%s): %s", d.Id(), err)
		}
	} else {
