...
// Description: <i>This object will be purged after policy copy and install.</i> Configure custom log fields.
...
func resourceLogCustomFieldCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadLogCustomField(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateLogCustomField(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateLogCustomField(obj, paradict, wsParams)
		if err != nil {
...
func resourceLogCustomFieldUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogCustomField(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating LogCustomField resource: %v", err)
	}
...
func resourceLogCustomFieldDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteLogCustomField(mkey, paradict, wsParams)
	if err != nil {
...
func flattenLogCustomFieldFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogCustomFieldFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenLogCustomFieldFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogCustomFieldUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogCustomField(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenLogCustomFieldFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "LogCustomField-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenLogCustomFieldFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "LogCustomField-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenLogCustomFieldFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "LogCustomField-FabricObjectSource"); ok {
	...
	if err = d.Set("fosid", flattenLogCustomFieldId(o["id"], d, "fosid")); err != nil {
		if vv, ok := fortiAPIPatch(o["id"], "LogCustomField-Id"); ok {
	...
	if err = d.Set("name", flattenLogCustomFieldName(o["name"], d, "name")); err != nil {
		if vv, ok := fortiAPIPatch(o["name"], "LogCustomField-Name"); ok {
	...
	if err = d.Set("uuid", flattenLogCustomFieldUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "LogCustomField-Uuid"); ok {
	...
	if err = d.Set("value", flattenLogCustomFieldValue(o["value"], d, "value")); err != nil {
		if vv, ok := fortiAPIPatch(o["value"], "LogCustomField-Value"); ok {
...
func expandLogCustomFieldFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogCustomFieldFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandLogCustomFieldFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogCustomFieldUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogCustomField(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandLogCustomFieldFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandLogCustomFieldFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandLogCustomFieldFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandLogCustomFieldUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
