...
// Description: <i>This object will be purged after policy copy and install.</i> Config global Wildcard FQDN address groups.
...
func resourceFirewallWildcardFqdnGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadFirewallWildcardFqdnGroup(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateFirewallWildcardFqdnGroup(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateFirewallWildcardFqdnGroup(obj, paradict, wsParams)
		if err != nil {
...
func resourceFirewallWildcardFqdnGroupUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateFirewallWildcardFqdnGroup(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating FirewallWildcardFqdnGroup resource: %v", err)
	}
...
func resourceFirewallWildcardFqdnGroupDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteFirewallWildcardFqdnGroup(mkey, paradict, wsParams)
	if err != nil {
...
func flattenFirewallWildcardFqdnGroupMember(v interface{}, d *schema.ResourceData, pre string) interface{} {
...
func refreshObjectFirewallWildcardFqdnGroup(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("color", flattenFirewallWildcardFqdnGroupColor(o["color"], d, "color")); err != nil {
		if vv, ok := fortiAPIPatch(o["color"], "FirewallWildcardFqdnGroup-Color"); ok {
	...
	if err = d.Set("comment", flattenFirewallWildcardFqdnGroupComment(o["comment"], d, "comment")); err != nil {
		if vv, ok := fortiAPIPatch(o["comment"], "FirewallWildcardFqdnGroup-Comment"); ok {
	...
	if err = d.Set("member", flattenFirewallWildcardFqdnGroupMember(o["member"], d, "member")); err != nil {
		if vv, ok := fortiAPIPatch(o["member"], "FirewallWildcardFqdnGroup-Member"); ok {
	...
	if err = d.Set("name", flattenFirewallWildcardFqdnGroupName(o["name"], d, "name")); err != nil {
		if vv, ok := fortiAPIPatch(o["name"], "FirewallWildcardFqdnGroup-Name"); ok {
	...
	if err = d.Set("uuid", flattenFirewallWildcardFqdnGroupUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "FirewallWildcardFqdnGroup-Uuid"); ok {
