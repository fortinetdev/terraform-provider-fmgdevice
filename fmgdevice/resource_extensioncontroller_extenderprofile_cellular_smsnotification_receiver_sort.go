...
func resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate,
		Read:   resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead,
		Update: resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ExtensionControllerExtenderProfileCellularSmsNotificationReceiver: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead(d, m)
}

func resourceExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ExtensionControllerExtenderProfileCellularSmsNotificationReceiver sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ExtensionControllerExtenderProfileCellularSmsNotificationReceiver List for (%s): %s", d.Id(), err)
		}
	} else {
