...
func flattenFirewallScheduleRecurringFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenFirewallScheduleRecurringFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallScheduleRecurringLabelDay(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectFirewallScheduleRecurring(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenFirewallScheduleRecurringFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "FirewallScheduleRecurring-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object_source", flattenFirewallScheduleRecurringFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "FirewallScheduleRecurring-FabricObjectSource"); ok {
	...
	if err = d.Set("label_day", flattenFirewallScheduleRecurringLabelDay(o["label-day"], d, "label_day")); err != nil {
		if vv, ok := fortiAPIPatch(o["label-day"], "FirewallScheduleRecurring-LabelDay"); ok {
...
func expandFirewallScheduleRecurringFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallScheduleRecurringFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandFirewallScheduleRecurringLabelDay(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallScheduleRecurring(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandFirewallScheduleRecurringFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandFirewallScheduleRecurringFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("label_day"); ok || d.HasChange("label_day") {
		t, err := expandFirewallScheduleRecurringLabelDay(d, v, "label_day")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["label-day"] = t
