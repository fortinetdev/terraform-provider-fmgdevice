...
func resourceWirelessControllerApStatusCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerApStatus(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerApStatus(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerApStatusUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerApStatus(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerApStatus resource: %v", err)
	}
...
func resourceWirelessControllerApStatusDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerApStatus(mkey, paradict, wsParams)
	if err != nil {
