...
func resourceLogSyslogd2OverrideSettingCustomFieldNameCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateLogSyslogd2OverrideSettingCustomFieldName(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateLogSyslogd2OverrideSettingCustomFieldName(obj, paradict, wsParams)
		if err != nil {
...
func resourceLogSyslogd2OverrideSettingCustomFieldNameUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogSyslogd2OverrideSettingCustomFieldName(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating LogSyslogd2OverrideSettingCustomFieldName resource: %v", err)
	}
...
func resourceLogSyslogd2OverrideSettingCustomFieldNameDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteLogSyslogd2OverrideSettingCustomFieldName(mkey, paradict, wsParams)
	if err != nil {
