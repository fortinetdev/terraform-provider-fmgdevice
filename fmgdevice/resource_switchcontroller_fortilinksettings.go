...
func resourceSwitchControllerFortilinkSettingsCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSwitchControllerFortilinkSettings(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSwitchControllerFortilinkSettings(obj, paradict, wsParams)
		if err != nil {
...
func resourceSwitchControllerFortilinkSettingsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSwitchControllerFortilinkSettings(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SwitchControllerFortilinkSettings resource: %v", err)
	}
...
func resourceSwitchControllerFortilinkSettingsDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSwitchControllerFortilinkSettings(mkey, paradict, wsParams)
	if err != nil {
