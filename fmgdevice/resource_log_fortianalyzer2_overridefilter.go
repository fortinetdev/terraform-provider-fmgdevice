...
func resourceLogFortianalyzer2OverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2OverrideFilter(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogFortianalyzer2OverrideFilter(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogFortianalyzer2OverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogFortianalyzer2OverrideFilter(d, true)
...
func flattenLogFortianalyzer2OverrideFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogFortianalyzer2OverrideFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogFortianalyzer2OverrideFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogFortianalyzer2OverrideFilter-Debug"); ok {
...
func expandLogFortianalyzer2OverrideFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer2OverrideFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogFortianalyzer2OverrideFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
