...
func resourceLogSyslogd2FilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd2Filter(d, false)
	if err != nil {
	...
	_, err = c.UpdateLogSyslogd2Filter(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceLogSyslogd2FilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd2Filter(d, true)
...
func flattenLogSyslogd2FilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogSyslogd2FilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd2Filter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogSyslogd2FilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogSyslogd2Filter-Debug"); ok {
	...
	if err = d.Set("http_transaction", flattenLogSyslogd2FilterHttpTransaction(o["http-transaction"], d, "http_transaction")); err != nil {
		if vv, ok := fortiAPIPatch(o["http-transaction"], "LogSyslogd2Filter-HttpTransaction"); ok {
...
func expandLogSyslogd2FilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogSyslogd2FilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd2Filter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogSyslogd2FilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
	...
	if v, ok := d.GetOk("http_transaction"); ok || d.HasChange("http_transaction") {
		t, err := expandLogSyslogd2FilterHttpTransaction(d, v, "http_transaction")
		if err != nil {
			return &obj, err
		} else if t != nil {
