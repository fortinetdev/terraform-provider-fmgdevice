...
func resourceSystemSnmpUserCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSystemSnmpUser(obj, mkey, paradict, wsParams)
			if err != nil {
...
func flattenSystemSnmpUserVdoms(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenSystemSnmpUserVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectSystemSnmpUser(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("ha_direct", flattenSystemSnmpUserHaDirect(o["ha-direct"], d, "ha_direct")); err != nil {
		if vv, ok := fortiAPIPatch(o["ha-direct"], "SystemSnmpUser-HaDirect"); ok {
	...
	if err = d.Set("mib_view", flattenSystemSnmpUserMibView(o["mib-view"], d, "mib_view")); err != nil {
		if vv, ok := fortiAPIPatch(o["mib-view"], "SystemSnmpUser-MibView"); ok {
	...
	if err = d.Set("source_ip", flattenSystemSnmpUserSourceIp(o["source-ip"], d, "source_ip")); err != nil {
		if vv, ok := fortiAPIPatch(o["source-ip"], "SystemSnmpUser-SourceIp"); ok {
	...
	if err = d.Set("source_ipv6", flattenSystemSnmpUserSourceIpv6(o["source-ipv6"], d, "source_ipv6")); err != nil {
		if vv, ok := fortiAPIPatch(o["source-ipv6"], "SystemSnmpUser-SourceIpv6"); ok {
	...
	if err = d.Set("status", flattenSystemSnmpUserStatus(o["status"], d, "status")); err != nil {
		if vv, ok := fortiAPIPatch(o["status"], "SystemSnmpUser-Status"); ok {
	...
	if err = d.Set("trap_lport", flattenSystemSnmpUserTrapLport(o["trap-lport"], d, "trap_lport")); err != nil {
		if vv, ok := fortiAPIPatch(o["trap-lport"], "SystemSnmpUser-TrapLport"); ok {
	...
	if err = d.Set("trap_rport", flattenSystemSnmpUserTrapRport(o["trap-rport"], d, "trap_rport")); err != nil {
		if vv, ok := fortiAPIPatch(o["trap-rport"], "SystemSnmpUser-TrapRport"); ok {
	...
	if err = d.Set("trap_status", flattenSystemSnmpUserTrapStatus(o["trap-status"], d, "trap_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["trap-status"], "SystemSnmpUser-TrapStatus"); ok {
	...
	if err = d.Set("vdoms", flattenSystemSnmpUserVdoms(o["vdoms"], d, "vdoms")); err != nil {
		if vv, ok := fortiAPIPatch(o["vdoms"], "SystemSnmpUser-Vdoms"); ok {
	...
	if err = d.Set("vrf_select", flattenSystemSnmpUserVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "SystemSnmpUser-VrfSelect"); ok {
...
func expandSystemSnmpUserVdoms(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandSystemSnmpUserVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemSnmpUser(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("mib_view"); ok || d.HasChange("mib_view") {
		t, err := expandSystemSnmpUserMibView(d, v, "mib_view")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["mib-view"] = t
	...
	if v, ok := d.GetOk("vdoms"); ok || d.HasChange("vdoms") {
		t, err := expandSystemSnmpUserVdoms(d, v, "vdoms")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vdoms"] = t
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandSystemSnmpUserVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
