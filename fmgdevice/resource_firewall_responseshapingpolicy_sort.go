...
func resourceFirewallResponseShapingPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirewallResponseShapingPolicySortCreateUpdate,
		Read:   resourceFirewallResponseShapingPolicySortRead,
		Update: resourceFirewallResponseShapingPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourceFirewallResponseShapingPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateFirewallResponseShapingPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting FirewallResponseShapingPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceFirewallResponseShapingPolicySortRead(d, m)
}

func resourceFirewallResponseShapingPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadFirewallResponseShapingPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading FirewallResponseShapingPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading FirewallResponseShapingPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
