...
func resourceWirelessControllerWtpRadio1Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWirelessControllerWtpRadio1(d, false)
	if err != nil {
...
func resourceWirelessControllerWtpRadio1Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWirelessControllerWtpRadio1(d, true)
	...
	_, err = c.UpdateWirelessControllerWtpRadio1(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing WirelessControllerWtpRadio1 resource: %v", err)
	}
...
func flattenWirelessControllerWtpRadio1CcaThreshold2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio1OverrideCcaThreshold2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio1OverrideVapStatus2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio1VapStatus2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio1Vap102edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap112edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap122edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap132edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap142edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap152edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWtpRadio1Vap162edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpRadio1Vap92edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectWirelessControllerWtpRadio1(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("cca_threshold", flattenWirelessControllerWtpRadio1CcaThreshold2edl(o["cca-threshold"], d, "cca_threshold")); err != nil {
		if vv, ok := fortiAPIPatch(o["cca-threshold"], "WirelessControllerWtpRadio1-CcaThreshold"); ok {
	...
	if err = d.Set("override_cca_threshold", flattenWirelessControllerWtpRadio1OverrideCcaThreshold2edl(o["override-cca-threshold"], d, "override_cca_threshold")); err != nil {
		if vv, ok := fortiAPIPatch(o["override-cca-threshold"], "WirelessControllerWtpRadio1-OverrideCcaThreshold"); ok {
	...
	if err = d.Set("override_vap_status", flattenWirelessControllerWtpRadio1OverrideVapStatus2edl(o["override-vap-status"], d, "override_vap_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["override-vap-status"], "WirelessControllerWtpRadio1-OverrideVapStatus"); ok {
	...
	if err = d.Set("vap_status", flattenWirelessControllerWtpRadio1VapStatus2edl(o["vap-status"], d, "vap_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap-status"], "WirelessControllerWtpRadio1-VapStatus"); ok {
	...
	if err = d.Set("vap10", flattenWirelessControllerWtpRadio1Vap102edl(o["vap10"], d, "vap10")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap10"], "WirelessControllerWtpRadio1-Vap10"); ok {
	...
	if err = d.Set("vap11", flattenWirelessControllerWtpRadio1Vap112edl(o["vap11"], d, "vap11")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap11"], "WirelessControllerWtpRadio1-Vap11"); ok {
	...
	if err = d.Set("vap12", flattenWirelessControllerWtpRadio1Vap122edl(o["vap12"], d, "vap12")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap12"], "WirelessControllerWtpRadio1-Vap12"); ok {
	...
	if err = d.Set("vap13", flattenWirelessControllerWtpRadio1Vap132edl(o["vap13"], d, "vap13")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap13"], "WirelessControllerWtpRadio1-Vap13"); ok {
	...
	if err = d.Set("vap14", flattenWirelessControllerWtpRadio1Vap142edl(o["vap14"], d, "vap14")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap14"], "WirelessControllerWtpRadio1-Vap14"); ok {
	...
	if err = d.Set("vap15", flattenWirelessControllerWtpRadio1Vap152edl(o["vap15"], d, "vap15")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap15"], "WirelessControllerWtpRadio1-Vap15"); ok {
	...
	if err = d.Set("vap16", flattenWirelessControllerWtpRadio1Vap162edl(o["vap16"], d, "vap16")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap16"], "WirelessControllerWtpRadio1-Vap16"); ok {
	...
	if err = d.Set("vap9", flattenWirelessControllerWtpRadio1Vap92edl(o["vap9"], d, "vap9")); err != nil {
		if vv, ok := fortiAPIPatch(o["vap9"], "WirelessControllerWtpRadio1-Vap9"); ok {
...
func expandWirelessControllerWtpRadio1CcaThreshold2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio1OverrideCcaThreshold2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio1OverrideVapStatus2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio1VapStatus2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio1Vap102edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap112edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap122edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap132edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap142edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap152edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpRadio1Vap162edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpRadio1Vap92edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectWirelessControllerWtpRadio1(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("cca_threshold"); ok || d.HasChange("cca_threshold") {
		t, err := expandWirelessControllerWtpRadio1CcaThreshold2edl(d, v, "cca_threshold")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["cca-threshold"] = t
	...
	if v, ok := d.GetOk("override_cca_threshold"); ok || d.HasChange("override_cca_threshold") {
		t, err := expandWirelessControllerWtpRadio1OverrideCcaThreshold2edl(d, v, "override_cca_threshold")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("override_vap_status"); ok || d.HasChange("override_vap_status") {
		t, err := expandWirelessControllerWtpRadio1OverrideVapStatus2edl(d, v, "override_vap_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("vap_status"); ok || d.HasChange("vap_status") {
		t, err := expandWirelessControllerWtpRadio1VapStatus2edl(d, v, "vap_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap-status"] = t
	...
	if v, ok := d.GetOk("vap10"); ok || d.HasChange("vap10") {
		t, err := expandWirelessControllerWtpRadio1Vap102edl(d, v, "vap10")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap10"] = t
	...
	if v, ok := d.GetOk("vap11"); ok || d.HasChange("vap11") {
		t, err := expandWirelessControllerWtpRadio1Vap112edl(d, v, "vap11")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap11"] = t
	...
	if v, ok := d.GetOk("vap12"); ok || d.HasChange("vap12") {
		t, err := expandWirelessControllerWtpRadio1Vap122edl(d, v, "vap12")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap12"] = t
	...
	if v, ok := d.GetOk("vap13"); ok || d.HasChange("vap13") {
		t, err := expandWirelessControllerWtpRadio1Vap132edl(d, v, "vap13")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap13"] = t
	...
	if v, ok := d.GetOk("vap14"); ok || d.HasChange("vap14") {
		t, err := expandWirelessControllerWtpRadio1Vap142edl(d, v, "vap14")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap14"] = t
	...
	if v, ok := d.GetOk("vap15"); ok || d.HasChange("vap15") {
		t, err := expandWirelessControllerWtpRadio1Vap152edl(d, v, "vap15")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap15"] = t
	...
	if v, ok := d.GetOk("vap16"); ok || d.HasChange("vap16") {
		t, err := expandWirelessControllerWtpRadio1Vap162edl(d, v, "vap16")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap16"] = t
	...
	if v, ok := d.GetOk("vap9"); ok || d.HasChange("vap9") {
		t, err := expandWirelessControllerWtpRadio1Vap92edl(d, v, "vap9")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vap9"] = t
