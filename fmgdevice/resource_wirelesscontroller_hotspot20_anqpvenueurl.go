...
func resourceWirelessControllerHotspot20AnqpVenueUrlCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWirelessControllerHotspot20AnqpVenueUrl(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWirelessControllerHotspot20AnqpVenueUrl(obj, paradict, wsParams)
		if err != nil {
...
func resourceWirelessControllerHotspot20AnqpVenueUrlUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWirelessControllerHotspot20AnqpVenueUrl(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WirelessControllerHotspot20AnqpVenueUrl resource: %v", err)
	}
...
func resourceWirelessControllerHotspot20AnqpVenueUrlDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWirelessControllerHotspot20AnqpVenueUrl(mkey, paradict, wsParams)
	if err != nil {
