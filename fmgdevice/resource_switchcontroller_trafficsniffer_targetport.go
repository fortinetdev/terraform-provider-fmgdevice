...
func resourceSwitchControllerTrafficSnifferTargetPortCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSwitchControllerTrafficSnifferTargetPort(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSwitchControllerTrafficSnifferTargetPort(obj, paradict, wsParams)
		if err != nil {
...
func resourceSwitchControllerTrafficSnifferTargetPortUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSwitchControllerTrafficSnifferTargetPort(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SwitchControllerTrafficSnifferTargetPort resource: %v", err)
	}
...
func resourceSwitchControllerTrafficSnifferTargetPortDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSwitchControllerTrafficSnifferTargetPort(mkey, paradict, wsParams)
	if err != nil {
