...
func resourceSystemSdnConnectorRouteTableSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceSystemSdnConnectorRouteTableSortCreateUpdate,
		Read:   resourceSystemSdnConnectorRouteTableSortRead,
		Update: resourceSystemSdnConnectorRouteTableSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceSystemSdnConnectorRouteTableSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateSystemSdnConnectorRouteTableSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting SystemSdnConnectorRouteTable: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceSystemSdnConnectorRouteTableSortRead(d, m)
}

func resourceSystemSdnConnectorRouteTableSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadSystemSdnConnectorRouteTableSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading SystemSdnConnectorRouteTable sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading SystemSdnConnectorRouteTable List for (%s): %s", d.Id(), err)
		}
	} else {
