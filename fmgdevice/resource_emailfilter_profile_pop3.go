...
func resourceEmailfilterProfilePop3Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectEmailfilterProfilePop3(d, false)
	if err != nil {
...
func resourceEmailfilterProfilePop3Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectEmailfilterProfilePop3(d, true)
	...
	_, err = c.UpdateEmailfilterProfilePop3(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing EmailfilterProfilePop3 resource: %v", err)
	}
...
func getObjectEmailfilterProfilePop3(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
