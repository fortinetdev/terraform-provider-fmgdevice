...
func resourceApplicationUnsanctionedAppsSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceApplicationUnsanctionedAppsSortCreateUpdate,
		Read:   resourceApplicationUnsanctionedAppsSortRead,
		Update: resourceApplicationUnsanctionedAppsSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceApplicationUnsanctionedAppsSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateApplicationUnsanctionedAppsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ApplicationUnsanctionedApps: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceApplicationUnsanctionedAppsSortRead(d, m)
}

func resourceApplicationUnsanctionedAppsSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadApplicationUnsanctionedAppsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ApplicationUnsanctionedApps sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ApplicationUnsanctionedApps List for (%s): %s", d.Id(), err)
		}
	} else {
