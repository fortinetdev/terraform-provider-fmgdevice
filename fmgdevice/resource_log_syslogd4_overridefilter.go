...
func resourceLogSyslogd4OverrideFilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd4OverrideFilter(d, false)
	if err != nil {
...
func resourceLogSyslogd4OverrideFilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd4OverrideFilter(d, true)
...
func flattenLogSyslogd4OverrideFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd4OverrideFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogSyslogd4OverrideFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogSyslogd4OverrideFilter-Debug"); ok {
...
func expandLogSyslogd4OverrideFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd4OverrideFilter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogSyslogd4OverrideFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
