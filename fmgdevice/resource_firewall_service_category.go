...
func resourceFirewallServiceCategoryCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadFirewallServiceCategory(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateFirewallServiceCategory(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateFirewallServiceCategory(obj, paradict, wsParams)
		if err != nil {
...
func resourceFirewallServiceCategoryUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateFirewallServiceCategory(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating FirewallServiceCategory resource: %v", err)
	}
...
func resourceFirewallServiceCategoryDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteFirewallServiceCategory(mkey, paradict, wsParams)
	if err != nil {
...
func flattenFirewallServiceCategoryGlobalObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenFirewallServiceCategoryUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectFirewallServiceCategory(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("comment", flattenFirewallServiceCategoryComment(o["comment"], d, "comment")); err != nil {
		if vv, ok := fortiAPIPatch(o["comment"], "FirewallServiceCategory-Comment"); ok {
	...
	if err = d.Set("global_object", flattenFirewallServiceCategoryGlobalObject(o["global-object"], d, "global_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["global-object"], "FirewallServiceCategory-GlobalObject"); ok {
	...
	if err = d.Set("name", flattenFirewallServiceCategoryName(o["name"], d, "name")); err != nil {
		if vv, ok := fortiAPIPatch(o["name"], "FirewallServiceCategory-Name"); ok {
	...
	if err = d.Set("uuid", flattenFirewallServiceCategoryUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "FirewallServiceCategory-Uuid"); ok {
...
func expandFirewallServiceCategoryGlobalObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallServiceCategoryUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallServiceCategory(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("global_object"); ok || d.HasChange("global_object") {
		t, err := expandFirewallServiceCategoryGlobalObject(d, v, "global_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["global-object"] = t
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandFirewallServiceCategoryUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
