...
func resourceRouterOspf6Ospf6InterfaceNeighborCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateRouterOspf6Ospf6InterfaceNeighbor(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateRouterOspf6Ospf6InterfaceNeighbor(obj, paradict, wsParams)
		if err != nil {
...
func resourceRouterOspf6Ospf6InterfaceNeighborUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateRouterOspf6Ospf6InterfaceNeighbor(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating RouterOspf6Ospf6InterfaceNeighbor resource: %v", err)
	}
...
func resourceRouterOspf6Ospf6InterfaceNeighborDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteRouterOspf6Ospf6InterfaceNeighbor(mkey, paradict, wsParams)
	if err != nil {
