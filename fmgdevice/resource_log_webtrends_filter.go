...
func flattenLogWebtrendsFilterDebug(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenLogWebtrendsFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectLogWebtrendsFilter(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("debug", flattenLogWebtrendsFilterDebug(o["debug"], d, "debug")); err != nil {
		if vv, ok := fortiAPIPatch(o["debug"], "LogWebtrendsFilter-Debug"); ok {
	...
	if err = d.Set("http_transaction", flattenLogWebtrendsFilterHttpTransaction(o["http-transaction"], d, "http_transaction")); err != nil {
		if vv, ok := fortiAPIPatch(o["http-transaction"], "LogWebtrendsFilter-HttpTransaction"); ok {
...
func expandLogWebtrendsFilterDebug(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandLogWebtrendsFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogWebtrendsFilter(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("debug"); ok || d.HasChange("debug") {
		t, err := expandLogWebtrendsFilterDebug(d, v, "debug")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["debug"] = t
	...
	if v, ok := d.GetOk("http_transaction"); ok || d.HasChange("http_transaction") {
		t, err := expandLogWebtrendsFilterHttpTransaction(d, v, "http_transaction")
		if err != nil {
			return &obj, err
		} else if t != nil {
