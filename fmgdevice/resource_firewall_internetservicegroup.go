...
// Description: <i>This object will be purged after policy copy and install.</i> Configure group of Internet Service.
...
func resourceFirewallInternetServiceGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadFirewallInternetServiceGroup(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateFirewallInternetServiceGroup(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateFirewallInternetServiceGroup(obj, paradict, wsParams)
		if err != nil {
...
func resourceFirewallInternetServiceGroupUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateFirewallInternetServiceGroup(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating FirewallInternetServiceGroup resource: %v", err)
	}
...
func resourceFirewallInternetServiceGroupDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteFirewallInternetServiceGroup(mkey, paradict, wsParams)
	if err != nil {
...
func flattenFirewallInternetServiceGroupFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallInternetServiceGroupFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallInternetServiceGroupFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallInternetServiceGroupMember(v interface{}, d *schema.ResourceData, pre string) interface{} {
...
func flattenFirewallInternetServiceGroupUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectFirewallInternetServiceGroup(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("comment", flattenFirewallInternetServiceGroupComment(o["comment"], d, "comment")); err != nil {
		if vv, ok := fortiAPIPatch(o["comment"], "FirewallInternetServiceGroup-Comment"); ok {
	...
	if err = d.Set("direction", flattenFirewallInternetServiceGroupDirection(o["direction"], d, "direction")); err != nil {
		if vv, ok := fortiAPIPatch(o["direction"], "FirewallInternetServiceGroup-Direction"); ok {
	...
	if err = d.Set("fabric_force_sync", flattenFirewallInternetServiceGroupFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "FirewallInternetServiceGroup-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenFirewallInternetServiceGroupFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "FirewallInternetServiceGroup-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenFirewallInternetServiceGroupFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "FirewallInternetServiceGroup-FabricObjectSource"); ok {
	...
	if err = d.Set("member", flattenFirewallInternetServiceGroupMember(o["member"], d, "member")); err != nil {
		if vv, ok := fortiAPIPatch(o["member"], "FirewallInternetServiceGroup-Member"); ok {
	...
	if err = d.Set("name", flattenFirewallInternetServiceGroupName(o["name"], d, "name")); err != nil {
		if vv, ok := fortiAPIPatch(o["name"], "FirewallInternetServiceGroup-Name"); ok {
	...
	if err = d.Set("uuid", flattenFirewallInternetServiceGroupUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "FirewallInternetServiceGroup-Uuid"); ok {
...
func expandFirewallInternetServiceGroupFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandFirewallInternetServiceGroupFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandFirewallInternetServiceGroupFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallInternetServiceGroupUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallInternetServiceGroup(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandFirewallInternetServiceGroupFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandFirewallInternetServiceGroupFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandFirewallInternetServiceGroupFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandFirewallInternetServiceGroupUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
