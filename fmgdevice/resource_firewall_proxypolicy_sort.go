...
func resourceFirewallProxyPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateFirewallProxyPolicySort(&input_model)
	if err != nil {
...
func resourceFirewallProxyPolicySortRead(d *schema.ResourceData, m interface{}) error {
	...
	sorted, o, err := c.ReadFirewallProxyPolicySort(&input_model)
	if err != nil {
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading FirewallProxyPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
