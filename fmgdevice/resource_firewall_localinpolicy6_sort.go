...
func resourceFirewallLocalInPolicy6SortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateFirewallLocalInPolicy6Sort(&input_model)
	if err != nil {
...
func resourceFirewallLocalInPolicy6SortRead(d *schema.ResourceData, m interface{}) error {
	...
	sorted, o, err := c.ReadFirewallLocalInPolicy6Sort(&input_model)
	if err != nil {
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading FirewallLocalInPolicy6 List for (%s): %s", d.Id(), err)
		}
	} else {
