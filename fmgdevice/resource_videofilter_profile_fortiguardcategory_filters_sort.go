...
func resourceVideofilterProfileFortiguardCategoryFiltersSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate,
		Read:   resourceVideofilterProfileFortiguardCategoryFiltersSortRead,
		Update: resourceVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateVideofilterProfileFortiguardCategoryFiltersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting VideofilterProfileFortiguardCategoryFilters: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceVideofilterProfileFortiguardCategoryFiltersSortRead(d, m)
}

func resourceVideofilterProfileFortiguardCategoryFiltersSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadVideofilterProfileFortiguardCategoryFiltersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading VideofilterProfileFortiguardCategoryFilters sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading VideofilterProfileFortiguardCategoryFilters List for (%s): %s", d.Id(), err)
		}
	} else {
