...
func resourceAntivirusProfilePop3Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectAntivirusProfilePop3(d, false)
	if err != nil {
...
func resourceAntivirusProfilePop3Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectAntivirusProfilePop3(d, true)
	...
	_, err = c.UpdateAntivirusProfilePop3(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing AntivirusProfilePop3 resource: %v", err)
	}
...
func getObjectAntivirusProfilePop3(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
