...
func resourceWirelessControllerApcfgProfileCommandListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWirelessControllerApcfgProfileCommandListSortCreateUpdate,
		Read:   resourceWirelessControllerApcfgProfileCommandListSortRead,
		Update: resourceWirelessControllerApcfgProfileCommandListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWirelessControllerApcfgProfileCommandListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWirelessControllerApcfgProfileCommandListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WirelessControllerApcfgProfileCommandList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWirelessControllerApcfgProfileCommandListSortRead(d, m)
}

func resourceWirelessControllerApcfgProfileCommandListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWirelessControllerApcfgProfileCommandListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WirelessControllerApcfgProfileCommandList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WirelessControllerApcfgProfileCommandList List for (%s): %s", d.Id(), err)
		}
	} else {
