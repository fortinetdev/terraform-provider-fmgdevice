...
func resourceEmailfilterBlockAllowListEntriesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceEmailfilterBlockAllowListEntriesSortCreateUpdate,
		Read:   resourceEmailfilterBlockAllowListEntriesSortRead,
		Update: resourceEmailfilterBlockAllowListEntriesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceEmailfilterBlockAllowListEntriesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateEmailfilterBlockAllowListEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting EmailfilterBlockAllowListEntries: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceEmailfilterBlockAllowListEntriesSortRead(d, m)
}

func resourceEmailfilterBlockAllowListEntriesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadEmailfilterBlockAllowListEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading EmailfilterBlockAllowListEntries sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading EmailfilterBlockAllowListEntries List for (%s): %s", d.Id(), err)
		}
	} else {
