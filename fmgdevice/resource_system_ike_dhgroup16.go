...
func resourceSystemIkeDhGroup16Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectSystemIkeDhGroup16(d, false)
	if err != nil {
...
func resourceSystemIkeDhGroup16Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectSystemIkeDhGroup16(d, true)
	...
	_, err = c.UpdateSystemIkeDhGroup16(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing SystemIkeDhGroup16 resource: %v", err)
	}
...
func getObjectSystemIkeDhGroup16(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
