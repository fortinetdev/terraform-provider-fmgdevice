...
func flattenFirewallSslSshProfileFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallSslSshProfileFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallSslSshProfileFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileSslServer(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if _, ok := i["ftps-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerFtpsClientCertRequest(i["ftps-client-cert-request"], d, pre_append)
			tmp["ftps_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-FtpsClientCertRequest")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "https_client_cert_request"
		if _, ok := i["https-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerHttpsClientCertRequest(i["https-client-cert-request"], d, pre_append)
			tmp["https_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-HttpsClientCertRequest")
		}
		...
		if _, ok := i["imaps-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerImapsClientCertRequest(i["imaps-client-cert-request"], d, pre_append)
			tmp["imaps_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-ImapsClientCertRequest")
		}
		...
		if _, ok := i["pop3s-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerPop3SClientCertRequest(i["pop3s-client-cert-request"], d, pre_append)
			tmp["pop3s_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-Pop3SClientCertRequest")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "smtps_client_cert_request"
		if _, ok := i["smtps-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerSmtpsClientCertRequest(i["smtps-client-cert-request"], d, pre_append)
			tmp["smtps_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-SmtpsClientCertRequest")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "ssl_other_client_cert_request"
		if _, ok := i["ssl-other-client-cert-request"]; ok {
			v := flattenFirewallSslSshProfileSslServerSslOtherClientCertRequest(i["ssl-other-client-cert-request"], d, pre_append)
			tmp["ssl_other_client_cert_request"] = fortiAPISubPartPatch(v, "FirewallSslSshProfile-SslServer-SslOtherClientCertRequest")
		}
...
func flattenFirewallSslSshProfileUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectFirewallSslSshProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenFirewallSslSshProfileFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "FirewallSslSshProfile-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenFirewallSslSshProfileFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "FirewallSslSshProfile-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenFirewallSslSshProfileFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "FirewallSslSshProfile-FabricObjectSource"); ok {
	...
	if err = d.Set("uuid", flattenFirewallSslSshProfileUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "FirewallSslSshProfile-Uuid"); ok {
...
func expandFirewallSslSshProfileFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallSslSshProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandFirewallSslSshProfileFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandFirewallSslSshProfileFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandFirewallSslSshProfileFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandFirewallSslSshProfileUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
