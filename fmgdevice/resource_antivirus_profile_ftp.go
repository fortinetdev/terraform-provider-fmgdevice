...
func resourceAntivirusProfileFtpUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectAntivirusProfileFtp(d, false)
	if err != nil {
...
func resourceAntivirusProfileFtpDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectAntivirusProfileFtp(d, true)
	...
	_, err = c.UpdateAntivirusProfileFtp(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing AntivirusProfileFtp resource: %v", err)
	}
...
func getObjectAntivirusProfileFtp(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
